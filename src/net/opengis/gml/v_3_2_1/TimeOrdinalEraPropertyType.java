 ...
 * 
 * <p>Java-Klasse für TimeOrdinalEraPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeOrdinalEra-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeOrdinalEra-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeOrdinalEraType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeOrdinalEraType theTimeOrdinalEra;
            theTimeOrdinalEra = this.getTimeOrdinalEra();
            strategy.appendField(locator, this, "timeOrdinalEra", buffer, theTimeOrdinalEra);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = TimeOrdinalEraPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeOrdinalEraPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeOrdinalEraPropertyType that = ((TimeOrdinalEraPropertyType) object);
        {
            TimeOrdinalEraType lhsTimeOrdinalEra;
            lhsTimeOrdinalEra = this.getTimeOrdinalEra();
            TimeOrdinalEraType rhsTimeOrdinalEra;
            rhsTimeOrdinalEra = that.getTimeOrdinalEra();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeOrdinalEra", lhsTimeOrdinalEra), LocatorUtils.property(thatLocator, "timeOrdinalEra", rhsTimeOrdinalEra), lhsTimeOrdinalEra, rhsTimeOrdinalEra)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeOrdinalEraType theTimeOrdinalEra;
            theTimeOrdinalEra = this.getTimeOrdinalEra();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeOrdinalEra", theTimeOrdinalEra), currentHashCode, theTimeOrdinalEra);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeOrdinalEraPropertyType) {
            final TimeOrdinalEraPropertyType copy = ((TimeOrdinalEraPropertyType) draftCopy);
            if (this.isSetTimeOrdinalEra()) {
                TimeOrdinalEraType sourceTimeOrdinalEra;
                sourceTimeOrdinalEra = this.getTimeOrdinalEra();
                TimeOrdinalEraType copyTimeOrdinalEra = ((TimeOrdinalEraType) strategy.copy(LocatorUtils.property(locator, "timeOrdinalEra", sourceTimeOrdinalEra), sourceTimeOrdinalEra));
                copy.setTimeOrdinalEra(copyTimeOrdinalEra);
            } else {
                copy.timeOrdinalEra = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeOrdinalEraPropertyType) {
            final TimeOrdinalEraPropertyType target = this;
            final TimeOrdinalEraPropertyType leftObject = ((TimeOrdinalEraPropertyType) left);
            final TimeOrdinalEraPropertyType rightObject = ((TimeOrdinalEraPropertyType) right);
            {
                TimeOrdinalEraType lhsTimeOrdinalEra;
                lhsTimeOrdinalEra = leftObject.getTimeOrdinalEra();
                TimeOrdinalEraType rhsTimeOrdinalEra;
                rhsTimeOrdinalEra = rightObject.getTimeOrdinalEra();
                target.setTimeOrdinalEra(((TimeOrdinalEraType) strategy.merge(LocatorUtils.property(leftLocator, "timeOrdinalEra", lhsTimeOrdinalEra), LocatorUtils.property(rightLocator, "timeOrdinalEra", rhsTimeOrdinalEra), lhsTimeOrdinalEra, rhsTimeOrdinalEra)));
            }
            {
                boolean lhsOwns;
