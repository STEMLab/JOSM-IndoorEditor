 ...
 * 
 * <p>Java-Klasse für ImageDatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = ImageDatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImageDatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImageDatumPropertyType that = ((ImageDatumPropertyType) object);
        {
            ImageDatumType lhsImageDatum;
            lhsImageDatum = this.getImageDatum();
            ImageDatumType rhsImageDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ImageDatumPropertyType) {
            final ImageDatumPropertyType copy = ((ImageDatumPropertyType) draftCopy);
            if (this.isSetImageDatum()) {
                ImageDatumType sourceImageDatum;
                sourceImageDatum = this.getImageDatum();
                ImageDatumType copyImageDatum = ((ImageDatumType) strategy.copy(LocatorUtils.property(locator, "imageDatum", sourceImageDatum), sourceImageDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ImageDatumPropertyType) {
            final ImageDatumPropertyType target = this;
            final ImageDatumPropertyType leftObject = ((ImageDatumPropertyType) left);
            final ImageDatumPropertyType rightObject = ((ImageDatumPropertyType) right);
            {
                ImageDatumType lhsImageDatum;
                lhsImageDatum = leftObject.getImageDatum();
                ImageDatumType rhsImageDatum;
                rhsImageDatum = rightObject.getImageDatum();
                target.setImageDatum(((ImageDatumType) strategy.merge(LocatorUtils.property(leftLocator, "imageDatum", lhsImageDatum), LocatorUtils.property(rightLocator, "imageDatum", rhsImageDatum), lhsImageDatum, rhsImageDatum)));
            }
            {
                List<String> lhsNilReason;
