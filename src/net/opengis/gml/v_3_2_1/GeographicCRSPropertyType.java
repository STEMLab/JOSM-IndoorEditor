...
/**
 * <p>Java-Klasse für GeographicCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            GeographicCRSType theGeographicCRS;
            theGeographicCRS = this.getGeographicCRS();
            strategy.appendField(locator, this, "geographicCRS", buffer, theGeographicCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = GeographicCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeographicCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeographicCRSPropertyType that = ((GeographicCRSPropertyType) object);
        {
            GeographicCRSType lhsGeographicCRS;
            lhsGeographicCRS = this.getGeographicCRS();
            GeographicCRSType rhsGeographicCRS;
            rhsGeographicCRS = that.getGeographicCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geographicCRS", lhsGeographicCRS), LocatorUtils.property(thatLocator, "geographicCRS", rhsGeographicCRS), lhsGeographicCRS, rhsGeographicCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            GeographicCRSType theGeographicCRS;
            theGeographicCRS = this.getGeographicCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geographicCRS", theGeographicCRS), currentHashCode, theGeographicCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeographicCRSPropertyType) {
            final GeographicCRSPropertyType copy = ((GeographicCRSPropertyType) draftCopy);
            if (this.isSetGeographicCRS()) {
                GeographicCRSType sourceGeographicCRS;
                sourceGeographicCRS = this.getGeographicCRS();
                GeographicCRSType copyGeographicCRS = ((GeographicCRSType) strategy.copy(LocatorUtils.property(locator, "geographicCRS", sourceGeographicCRS), sourceGeographicCRS));
                copy.setGeographicCRS(copyGeographicCRS);
            } else {
                copy.geographicCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeographicCRSPropertyType) {
            final GeographicCRSPropertyType target = this;
            final GeographicCRSPropertyType leftObject = ((GeographicCRSPropertyType) left);
            final GeographicCRSPropertyType rightObject = ((GeographicCRSPropertyType) right);
            {
                GeographicCRSType lhsGeographicCRS;
                lhsGeographicCRS = leftObject.getGeographicCRS();
                GeographicCRSType rhsGeographicCRS;
                rhsGeographicCRS = rightObject.getGeographicCRS();
                target.setGeographicCRS(((GeographicCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geographicCRS", lhsGeographicCRS), LocatorUtils.property(rightLocator, "geographicCRS", rhsGeographicCRS), lhsGeographicCRS, rhsGeographicCRS)));
            }
            {
                List<String> lhsNilReason;
