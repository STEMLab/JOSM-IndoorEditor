...
/**
 * <p>Java-Klasse für DirectedEdgePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = DirectedEdgePropertyType.TYPE;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DirectedEdgePropertyType) {
            final DirectedEdgePropertyType target = this;
            final DirectedEdgePropertyType leftObject = ((DirectedEdgePropertyType) left);
            final DirectedEdgePropertyType rightObject = ((DirectedEdgePropertyType) right);
            {
                EdgeType lhsEdge;
