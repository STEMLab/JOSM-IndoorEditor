 ...
 * 
 * <p>Java-Klasse für TimeCalendarPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeCalendar-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeCalendar-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeCalendarType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeCalendarType theTimeCalendar;
            theTimeCalendar = this.getTimeCalendar();
            strategy.appendField(locator, this, "timeCalendar", buffer, theTimeCalendar);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = TimeCalendarPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeCalendarPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeCalendarPropertyType that = ((TimeCalendarPropertyType) object);
        {
            TimeCalendarType lhsTimeCalendar;
            lhsTimeCalendar = this.getTimeCalendar();
            TimeCalendarType rhsTimeCalendar;
            rhsTimeCalendar = that.getTimeCalendar();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeCalendar", lhsTimeCalendar), LocatorUtils.property(thatLocator, "timeCalendar", rhsTimeCalendar), lhsTimeCalendar, rhsTimeCalendar)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeCalendarType theTimeCalendar;
            theTimeCalendar = this.getTimeCalendar();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeCalendar", theTimeCalendar), currentHashCode, theTimeCalendar);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeCalendarPropertyType) {
            final TimeCalendarPropertyType copy = ((TimeCalendarPropertyType) draftCopy);
            if (this.isSetTimeCalendar()) {
                TimeCalendarType sourceTimeCalendar;
                sourceTimeCalendar = this.getTimeCalendar();
                TimeCalendarType copyTimeCalendar = ((TimeCalendarType) strategy.copy(LocatorUtils.property(locator, "timeCalendar", sourceTimeCalendar), sourceTimeCalendar));
                copy.setTimeCalendar(copyTimeCalendar);
            } else {
                copy.timeCalendar = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeCalendarPropertyType) {
            final TimeCalendarPropertyType target = this;
            final TimeCalendarPropertyType leftObject = ((TimeCalendarPropertyType) left);
            final TimeCalendarPropertyType rightObject = ((TimeCalendarPropertyType) right);
            {
                TimeCalendarType lhsTimeCalendar;
                lhsTimeCalendar = leftObject.getTimeCalendar();
                TimeCalendarType rhsTimeCalendar;
                rhsTimeCalendar = rightObject.getTimeCalendar();
                target.setTimeCalendar(((TimeCalendarType) strategy.merge(LocatorUtils.property(leftLocator, "timeCalendar", lhsTimeCalendar), LocatorUtils.property(rightLocator, "timeCalendar", rhsTimeCalendar), lhsTimeCalendar, rhsTimeCalendar)));
            }
            {
                boolean lhsOwns;
