 ...
 * 
 * <p>Java-Klasse für TransformationPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TransformationType theTransformation;
            theTransformation = this.getTransformation();
            strategy.appendField(locator, this, "transformation", buffer, theTransformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TransformationPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TransformationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TransformationPropertyType that = ((TransformationPropertyType) object);
        {
            TransformationType lhsTransformation;
            lhsTransformation = this.getTransformation();
            TransformationType rhsTransformation;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TransformationPropertyType) {
            final TransformationPropertyType copy = ((TransformationPropertyType) draftCopy);
            if (this.isSetTransformation()) {
                TransformationType sourceTransformation;
                sourceTransformation = this.getTransformation();
                TransformationType copyTransformation = ((TransformationType) strategy.copy(LocatorUtils.property(locator, "transformation", sourceTransformation), sourceTransformation));
                copy.setTransformation(copyTransformation);
            } else {
                copy.transformation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TransformationPropertyType) {
            final TransformationPropertyType target = this;
            final TransformationPropertyType leftObject = ((TransformationPropertyType) left);
            final TransformationPropertyType rightObject = ((TransformationPropertyType) right);
            {
                TransformationType lhsTransformation;
                lhsTransformation = leftObject.getTransformation();
                TransformationType rhsTransformation;
                rhsTransformation = rightObject.getTransformation();
                target.setTransformation(((TransformationType) strategy.merge(LocatorUtils.property(leftLocator, "transformation", lhsTransformation), LocatorUtils.property(rightLocator, "transformation", rhsTransformation), lhsTransformation, rhsTransformation)));
            }
            {
                List<String> lhsNilReason;
