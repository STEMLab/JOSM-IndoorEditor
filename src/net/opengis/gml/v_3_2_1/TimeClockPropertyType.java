 ...
 * 
 * <p>Java-Klasse für TimeClockPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeClockType theTimeClock;
            theTimeClock = this.getTimeClock();
            strategy.appendField(locator, this, "timeClock", buffer, theTimeClock);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = TimeClockPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeClockPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            TimeClockType lhsTimeClock;
            lhsTimeClock = this.getTimeClock();
            TimeClockType rhsTimeClock;
            rhsTimeClock = that.getTimeClock();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeClock", lhsTimeClock), LocatorUtils.property(thatLocator, "timeClock", rhsTimeClock), lhsTimeClock, rhsTimeClock)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeClockType theTimeClock;
            theTimeClock = this.getTimeClock();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeClock", theTimeClock), currentHashCode, theTimeClock);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeClockPropertyType) {
            final TimeClockPropertyType copy = ((TimeClockPropertyType) draftCopy);
            if (this.isSetTimeClock()) {
                TimeClockType sourceTimeClock;
                sourceTimeClock = this.getTimeClock();
                TimeClockType copyTimeClock = ((TimeClockType) strategy.copy(LocatorUtils.property(locator, "timeClock", sourceTimeClock), sourceTimeClock));
                copy.setTimeClock(copyTimeClock);
            } else {
                copy.timeClock = null;
            }
            if (this.isSetOwns()) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeClockPropertyType) {
            final TimeClockPropertyType target = this;
            final TimeClockPropertyType leftObject = ((TimeClockPropertyType) left);
            final TimeClockPropertyType rightObject = ((TimeClockPropertyType) right);
            {
                TimeClockType lhsTimeClock;
                lhsTimeClock = leftObject.getTimeClock();
                TimeClockType rhsTimeClock;
                rhsTimeClock = rightObject.getTimeClock();
                target.setTimeClock(((TimeClockType) strategy.merge(LocatorUtils.property(leftLocator, "timeClock", lhsTimeClock), LocatorUtils.property(rightLocator, "timeClock", rhsTimeClock), lhsTimeClock, rhsTimeClock)));
            }
            {
                boolean lhsOwns;
