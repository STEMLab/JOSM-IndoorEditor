...
public class ObjectFactory {
    ...
    private final static QName _ImageDatumPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "imageDatum");
    ...
    private final static QName _OperationParameterPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "operationParameter");
    ...
    private final static QName _TimeCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "timeCS");
    ...
    private final static QName _GeodeticDatumPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "geodeticDatum");
    ...
    private final static QName _TemporalDatumPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "temporalDatum");
    ...
    private final static QName _ParameterValuePropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "parameterValue");
    ...
    private final static QName _UserDefinedCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "userDefinedCS");
    ...
    private final static QName _EllipsoidPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "ellipsoid");
    ...
    private final static QName _ConversionPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "conversion");
    ...
    private final static QName _PrimeMeridianPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "primeMeridian");
    ...
    private final static QName _EngineeringDatumPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "engineeringDatum");
    ...
    private final static QName _CartesianCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "cartesianCS");
    ...
    private final static QName _SphericalCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "sphericalCS");
    ...
    private final static QName _VerticalCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "verticalCS");
    ...
    private final static QName _PolarCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "polarCS");
    ...
    private final static QName _LinearCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "linearCS");
    ...
    private final static QName _CylindricalCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "cylindricalCS");
    ...
    private final static QName _EllipsoidalCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "ellipsoidalCS");
    ...
    private final static QName _AffineCSPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "affineCS");
    ...
    private final static QName _VerticalDatumPropertyElement_QNAME = new QName("http://www.opengis.net/gml/3.2", "verticalDatum");
    ...
    public JAXBElement<UserDefinedCSPropertyType> createUserDefinedCSPropertyElement(UserDefinedCSPropertyType value) {
        return new JAXBElement<UserDefinedCSPropertyType>(_UserDefinedCSPropertyElement_QNAME, UserDefinedCSPropertyType.class, null, value);
    }
    ...
    public JAXBElement<PolarCSPropertyType> createPolarCSPropertyElement(PolarCSPropertyType value) {
        return new JAXBElement<PolarCSPropertyType>(_PolarCSPropertyElement_QNAME, PolarCSPropertyType.class, null, value);
    }
    ...
    public JAXBElement<LinearCSPropertyType> createLinearCSPropertyElement(LinearCSPropertyType value) {
        return new JAXBElement<LinearCSPropertyType>(_LinearCSPropertyElement_QNAME, LinearCSPropertyType.class, null, value);
    }
    ...
    public JAXBElement<CylindricalCSPropertyType> createCylindricalCSPropertyElement(CylindricalCSPropertyType value) {
        return new JAXBElement<CylindricalCSPropertyType>(_CylindricalCSPropertyElement_QNAME, CylindricalCSPropertyType.class, null, value);
    }
