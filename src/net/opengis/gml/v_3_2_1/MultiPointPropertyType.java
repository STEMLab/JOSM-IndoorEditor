 ...
 * 
 * <p>Java-Klasse für MultiPointPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = MultiPointPropertyType.TYPE;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiPointPropertyType) {
            final MultiPointPropertyType target = this;
            final MultiPointPropertyType leftObject = ((MultiPointPropertyType) left);
            final MultiPointPropertyType rightObject = ((MultiPointPropertyType) right);
            {
                MultiPointType lhsMultiPoint;
                lhsMultiPoint = leftObject.getMultiPoint();
                MultiPointType rhsMultiPoint;
                rhsMultiPoint = rightObject.getMultiPoint();
                target.setMultiPoint(((MultiPointType) strategy.merge(LocatorUtils.property(leftLocator, "multiPoint", lhsMultiPoint), LocatorUtils.property(rightLocator, "multiPoint", rhsMultiPoint), lhsMultiPoint, rhsMultiPoint)));
            }
            {
                List<String> lhsNilReason;
