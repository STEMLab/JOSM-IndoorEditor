...
/**
 * <p>Java-Klasse für NodePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final NodePropertyType that = ((NodePropertyType) object);
        {
            NodeType lhsNode;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof NodePropertyType) {
            final NodePropertyType copy = ((NodePropertyType) draftCopy);
            if (this.isSetNode()) {
                NodeType sourceNode;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof NodePropertyType) {
            final NodePropertyType target = this;
            final NodePropertyType leftObject = ((NodePropertyType) left);
            final NodePropertyType rightObject = ((NodePropertyType) right);
            {
                NodeType lhsNode;
