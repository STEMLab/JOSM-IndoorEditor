 ...
 * 
 * <p>Java-Klasse für TimeCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = TimeCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeCSPropertyType that = ((TimeCSPropertyType) object);
        {
            TimeCSType lhsTimeCS;
            lhsTimeCS = this.getTimeCS();
            TimeCSType rhsTimeCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeCSPropertyType) {
            final TimeCSPropertyType copy = ((TimeCSPropertyType) draftCopy);
            if (this.isSetTimeCS()) {
                TimeCSType sourceTimeCS;
                sourceTimeCS = this.getTimeCS();
                TimeCSType copyTimeCS = ((TimeCSType) strategy.copy(LocatorUtils.property(locator, "timeCS", sourceTimeCS), sourceTimeCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeCSPropertyType) {
            final TimeCSPropertyType target = this;
            final TimeCSPropertyType leftObject = ((TimeCSPropertyType) left);
            final TimeCSPropertyType rightObject = ((TimeCSPropertyType) right);
            {
                TimeCSType lhsTimeCS;
                lhsTimeCS = leftObject.getTimeCS();
                TimeCSType rhsTimeCS;
                rhsTimeCS = rightObject.getTimeCS();
                target.setTimeCS(((TimeCSType) strategy.merge(LocatorUtils.property(leftLocator, "timeCS", lhsTimeCS), LocatorUtils.property(rightLocator, "timeCS", rhsTimeCS), lhsTimeCS, rhsTimeCS)));
            }
            {
                List<String> lhsNilReason;
