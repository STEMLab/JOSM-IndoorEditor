 ...
 * 
 * <p>Java-Klasse für TemporalDatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TemporalDatumType theTemporalDatum;
        ...
        {
            String theTYPE;
            theTYPE = TemporalDatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TemporalDatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TemporalDatumPropertyType that = ((TemporalDatumPropertyType) object);
        {
            TemporalDatumType lhsTemporalDatum;
            lhsTemporalDatum = this.getTemporalDatum();
            TemporalDatumType rhsTemporalDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TemporalDatumPropertyType) {
            final TemporalDatumPropertyType copy = ((TemporalDatumPropertyType) draftCopy);
            if (this.isSetTemporalDatum()) {
                TemporalDatumType sourceTemporalDatum;
                sourceTemporalDatum = this.getTemporalDatum();
                TemporalDatumType copyTemporalDatum = ((TemporalDatumType) strategy.copy(LocatorUtils.property(locator, "temporalDatum", sourceTemporalDatum), sourceTemporalDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TemporalDatumPropertyType) {
            final TemporalDatumPropertyType target = this;
            final TemporalDatumPropertyType leftObject = ((TemporalDatumPropertyType) left);
            final TemporalDatumPropertyType rightObject = ((TemporalDatumPropertyType) right);
            {
                TemporalDatumType lhsTemporalDatum;
                lhsTemporalDatum = leftObject.getTemporalDatum();
                TemporalDatumType rhsTemporalDatum;
                rhsTemporalDatum = rightObject.getTemporalDatum();
                target.setTemporalDatum(((TemporalDatumType) strategy.merge(LocatorUtils.property(leftLocator, "temporalDatum", lhsTemporalDatum), LocatorUtils.property(rightLocator, "temporalDatum", rhsTemporalDatum), lhsTemporalDatum, rhsTemporalDatum)));
            }
            {
                List<String> lhsNilReason;
