...
/**
 * <p>Java-Klasse für CountPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = CountPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CountPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CountPropertyType that = ((CountPropertyType) object);
        {
            Count lhsCount;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CountPropertyType) {
            final CountPropertyType copy = ((CountPropertyType) draftCopy);
            if (this.isSetCount()) {
                Count sourceCount;
                sourceCount = this.getCount();
                Count copyCount = ((Count) strategy.copy(LocatorUtils.property(locator, "count", sourceCount), sourceCount));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CountPropertyType) {
            final CountPropertyType target = this;
            final CountPropertyType leftObject = ((CountPropertyType) left);
            final CountPropertyType rightObject = ((CountPropertyType) right);
            {
                Count lhsCount;
                lhsCount = leftObject.getCount();
                Count rhsCount;
                rhsCount = rightObject.getCount();
                target.setCount(((Count) strategy.merge(LocatorUtils.property(leftLocator, "count", lhsCount), LocatorUtils.property(rightLocator, "count", rhsCount), lhsCount, rhsCount)));
            }
            {
                List<String> lhsNilReason;
