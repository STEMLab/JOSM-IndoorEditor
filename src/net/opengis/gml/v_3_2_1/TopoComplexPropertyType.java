...
/**
 * <p>Java-Klasse für TopoComplexPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TopoComplexType theTopoComplex;
            theTopoComplex = this.getTopoComplex();
            strategy.appendField(locator, this, "topoComplex", buffer, theTopoComplex);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TopoComplexPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TopoComplexPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            TopoComplexType lhsTopoComplex;
            lhsTopoComplex = this.getTopoComplex();
            TopoComplexType rhsTopoComplex;
            rhsTopoComplex = that.getTopoComplex();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "topoComplex", lhsTopoComplex), LocatorUtils.property(thatLocator, "topoComplex", rhsTopoComplex), lhsTopoComplex, rhsTopoComplex)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TopoComplexType theTopoComplex;
            theTopoComplex = this.getTopoComplex();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "topoComplex", theTopoComplex), currentHashCode, theTopoComplex);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopoComplexPropertyType) {
            final TopoComplexPropertyType copy = ((TopoComplexPropertyType) draftCopy);
            if (this.isSetTopoComplex()) {
                TopoComplexType sourceTopoComplex;
                sourceTopoComplex = this.getTopoComplex();
                TopoComplexType copyTopoComplex = ((TopoComplexType) strategy.copy(LocatorUtils.property(locator, "topoComplex", sourceTopoComplex), sourceTopoComplex));
                copy.setTopoComplex(copyTopoComplex);
            } else {
                copy.topoComplex = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopoComplexPropertyType) {
            final TopoComplexPropertyType target = this;
            final TopoComplexPropertyType leftObject = ((TopoComplexPropertyType) left);
            final TopoComplexPropertyType rightObject = ((TopoComplexPropertyType) right);
            {
                TopoComplexType lhsTopoComplex;
                lhsTopoComplex = leftObject.getTopoComplex();
                TopoComplexType rhsTopoComplex;
                rhsTopoComplex = rightObject.getTopoComplex();
                target.setTopoComplex(((TopoComplexType) strategy.merge(LocatorUtils.property(leftLocator, "topoComplex", lhsTopoComplex), LocatorUtils.property(rightLocator, "topoComplex", rhsTopoComplex), lhsTopoComplex, rhsTopoComplex)));
            }
            {
                List<String> lhsNilReason;
