...
public class PointPropertyType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = PointPropertyType.TYPE;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PointPropertyType) {
            final PointPropertyType copy = ((PointPropertyType) draftCopy);
            if (this.isSetPoint()) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PointPropertyType) {
            final PointPropertyType target = this;
            final PointPropertyType leftObject = ((PointPropertyType) left);
            final PointPropertyType rightObject = ((PointPropertyType) right);
            {
                PointType lhsPoint;
                lhsPoint = leftObject.getPoint();
                PointType rhsPoint;
                rhsPoint = rightObject.getPoint();
                target.setPoint(((PointType) strategy.merge(LocatorUtils.property(leftLocator, "point", lhsPoint), LocatorUtils.property(rightLocator, "point", rhsPoint), lhsPoint, rhsPoint)));
            }
            {
                List<String> lhsNilReason;
