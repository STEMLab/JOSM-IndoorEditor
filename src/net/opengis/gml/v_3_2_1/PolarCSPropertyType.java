 ...
 * 
 * <p>Java-Klasse für PolarCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = PolarCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PolarCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PolarCSPropertyType that = ((PolarCSPropertyType) object);
        {
            PolarCSType lhsPolarCS;
            lhsPolarCS = this.getPolarCS();
            PolarCSType rhsPolarCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PolarCSPropertyType) {
            final PolarCSPropertyType copy = ((PolarCSPropertyType) draftCopy);
            if (this.isSetPolarCS()) {
                PolarCSType sourcePolarCS;
                sourcePolarCS = this.getPolarCS();
                PolarCSType copyPolarCS = ((PolarCSType) strategy.copy(LocatorUtils.property(locator, "polarCS", sourcePolarCS), sourcePolarCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PolarCSPropertyType) {
            final PolarCSPropertyType target = this;
            final PolarCSPropertyType leftObject = ((PolarCSPropertyType) left);
            final PolarCSPropertyType rightObject = ((PolarCSPropertyType) right);
            {
                PolarCSType lhsPolarCS;
                lhsPolarCS = leftObject.getPolarCS();
                PolarCSType rhsPolarCS;
                rhsPolarCS = rightObject.getPolarCS();
                target.setPolarCS(((PolarCSType) strategy.merge(LocatorUtils.property(leftLocator, "polarCS", lhsPolarCS), LocatorUtils.property(rightLocator, "polarCS", rhsPolarCS), lhsPolarCS, rhsPolarCS)));
            }
            {
                List<String> lhsNilReason;
