 ...
 * 
 * <p>Java-Klasse für VerticalCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der verticalCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der verticalCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link VerticalCRSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            VerticalCRSType theVerticalCRS;
        ...
        {
            String theTYPE;
            theTYPE = VerticalCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalCRSPropertyType that = ((VerticalCRSPropertyType) object);
        {
            VerticalCRSType lhsVerticalCRS;
            lhsVerticalCRS = this.getVerticalCRS();
            VerticalCRSType rhsVerticalCRS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalCRSPropertyType) {
            final VerticalCRSPropertyType copy = ((VerticalCRSPropertyType) draftCopy);
            if (this.isSetVerticalCRS()) {
                VerticalCRSType sourceVerticalCRS;
                sourceVerticalCRS = this.getVerticalCRS();
                VerticalCRSType copyVerticalCRS = ((VerticalCRSType) strategy.copy(LocatorUtils.property(locator, "verticalCRS", sourceVerticalCRS), sourceVerticalCRS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalCRSPropertyType) {
            final VerticalCRSPropertyType target = this;
            final VerticalCRSPropertyType leftObject = ((VerticalCRSPropertyType) left);
            final VerticalCRSPropertyType rightObject = ((VerticalCRSPropertyType) right);
            {
                VerticalCRSType lhsVerticalCRS;
                lhsVerticalCRS = leftObject.getVerticalCRS();
                VerticalCRSType rhsVerticalCRS;
                rhsVerticalCRS = rightObject.getVerticalCRS();
                target.setVerticalCRS(((VerticalCRSType) strategy.merge(LocatorUtils.property(leftLocator, "verticalCRS", lhsVerticalCRS), LocatorUtils.property(rightLocator, "verticalCRS", rhsVerticalCRS), lhsVerticalCRS, rhsVerticalCRS)));
            }
            {
                List<String> lhsNilReason;
