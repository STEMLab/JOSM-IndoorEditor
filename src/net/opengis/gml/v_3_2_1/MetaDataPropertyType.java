...
/**
 * <p>Java-Klasse für MetaDataPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractMetaDataType> theAbstractMetaData;
        ...
        {
            String theTYPE;
            theTYPE = MetaDataPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MetaDataPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MetaDataPropertyType that = ((MetaDataPropertyType) object);
        {
            JAXBElement<? extends AbstractMetaDataType> lhsAbstractMetaData;
            lhsAbstractMetaData = this.getAbstractMetaData();
            JAXBElement<? extends AbstractMetaDataType> rhsAbstractMetaData;
            rhsAbstractMetaData = that.getAbstractMetaData();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractMetaData", lhsAbstractMetaData), LocatorUtils.property(thatLocator, "abstractMetaData", rhsAbstractMetaData), lhsAbstractMetaData, rhsAbstractMetaData)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractMetaDataType> theAbstractMetaData;
            theAbstractMetaData = this.getAbstractMetaData();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractMetaData", theAbstractMetaData), currentHashCode, theAbstractMetaData);
        }
        {
            String theAbout;
            theAbout = this.getAbout();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MetaDataPropertyType) {
            final MetaDataPropertyType copy = ((MetaDataPropertyType) draftCopy);
            if (this.isSetAbstractMetaData()) {
                JAXBElement<? extends AbstractMetaDataType> sourceAbstractMetaData;
                sourceAbstractMetaData = this.getAbstractMetaData();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractMetaDataType> copyAbstractMetaData = ((JAXBElement<? extends AbstractMetaDataType> ) strategy.copy(LocatorUtils.property(locator, "abstractMetaData", sourceAbstractMetaData), sourceAbstractMetaData));
                copy.setAbstractMetaData(copyAbstractMetaData);
            } else {
                copy.abstractMetaData = null;
            }
            if (this.isSetAbout()) {
                String sourceAbout;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MetaDataPropertyType) {
            final MetaDataPropertyType target = this;
            final MetaDataPropertyType leftObject = ((MetaDataPropertyType) left);
            final MetaDataPropertyType rightObject = ((MetaDataPropertyType) right);
            {
                JAXBElement<? extends AbstractMetaDataType> lhsAbstractMetaData;
                lhsAbstractMetaData = leftObject.getAbstractMetaData();
                JAXBElement<? extends AbstractMetaDataType> rhsAbstractMetaData;
                rhsAbstractMetaData = rightObject.getAbstractMetaData();
                target.setAbstractMetaData(((JAXBElement<? extends AbstractMetaDataType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractMetaData", lhsAbstractMetaData), LocatorUtils.property(rightLocator, "abstractMetaData", rhsAbstractMetaData), lhsAbstractMetaData, rhsAbstractMetaData)));
            }
            {
                String lhsAbout;
