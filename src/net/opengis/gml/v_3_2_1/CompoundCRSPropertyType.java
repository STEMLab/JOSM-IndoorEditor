 ...
 * 
 * <p>Java-Klasse für CompoundCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der compoundCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der compoundCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link CompoundCRSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CompoundCRSType theCompoundCRS;
            theCompoundCRS = this.getCompoundCRS();
            strategy.appendField(locator, this, "compoundCRS", buffer, theCompoundCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CompoundCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompoundCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompoundCRSPropertyType that = ((CompoundCRSPropertyType) object);
        {
            CompoundCRSType lhsCompoundCRS;
            lhsCompoundCRS = this.getCompoundCRS();
            CompoundCRSType rhsCompoundCRS;
            rhsCompoundCRS = that.getCompoundCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "compoundCRS", lhsCompoundCRS), LocatorUtils.property(thatLocator, "compoundCRS", rhsCompoundCRS), lhsCompoundCRS, rhsCompoundCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CompoundCRSType theCompoundCRS;
            theCompoundCRS = this.getCompoundCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "compoundCRS", theCompoundCRS), currentHashCode, theCompoundCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CompoundCRSPropertyType) {
            final CompoundCRSPropertyType copy = ((CompoundCRSPropertyType) draftCopy);
            if (this.isSetCompoundCRS()) {
                CompoundCRSType sourceCompoundCRS;
                sourceCompoundCRS = this.getCompoundCRS();
                CompoundCRSType copyCompoundCRS = ((CompoundCRSType) strategy.copy(LocatorUtils.property(locator, "compoundCRS", sourceCompoundCRS), sourceCompoundCRS));
                copy.setCompoundCRS(copyCompoundCRS);
            } else {
                copy.compoundCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CompoundCRSPropertyType) {
            final CompoundCRSPropertyType target = this;
            final CompoundCRSPropertyType leftObject = ((CompoundCRSPropertyType) left);
            final CompoundCRSPropertyType rightObject = ((CompoundCRSPropertyType) right);
            {
                CompoundCRSType lhsCompoundCRS;
                lhsCompoundCRS = leftObject.getCompoundCRS();
                CompoundCRSType rhsCompoundCRS;
                rhsCompoundCRS = rightObject.getCompoundCRS();
                target.setCompoundCRS(((CompoundCRSType) strategy.merge(LocatorUtils.property(leftLocator, "compoundCRS", lhsCompoundCRS), LocatorUtils.property(rightLocator, "compoundCRS", rhsCompoundCRS), lhsCompoundCRS, rhsCompoundCRS)));
            }
            {
                List<String> lhsNilReason;
