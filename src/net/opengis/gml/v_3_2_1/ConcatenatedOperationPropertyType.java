 ...
 * 
 * <p>Java-Klasse für ConcatenatedOperationPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der concatenatedOperation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der concatenatedOperation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ConcatenatedOperationType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ConcatenatedOperationType theConcatenatedOperation;
            theConcatenatedOperation = this.getConcatenatedOperation();
            strategy.appendField(locator, this, "concatenatedOperation", buffer, theConcatenatedOperation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ConcatenatedOperationPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConcatenatedOperationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ConcatenatedOperationPropertyType that = ((ConcatenatedOperationPropertyType) object);
        {
            ConcatenatedOperationType lhsConcatenatedOperation;
            lhsConcatenatedOperation = this.getConcatenatedOperation();
            ConcatenatedOperationType rhsConcatenatedOperation;
            rhsConcatenatedOperation = that.getConcatenatedOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "concatenatedOperation", lhsConcatenatedOperation), LocatorUtils.property(thatLocator, "concatenatedOperation", rhsConcatenatedOperation), lhsConcatenatedOperation, rhsConcatenatedOperation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ConcatenatedOperationType theConcatenatedOperation;
            theConcatenatedOperation = this.getConcatenatedOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "concatenatedOperation", theConcatenatedOperation), currentHashCode, theConcatenatedOperation);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ConcatenatedOperationPropertyType) {
            final ConcatenatedOperationPropertyType copy = ((ConcatenatedOperationPropertyType) draftCopy);
            if (this.isSetConcatenatedOperation()) {
                ConcatenatedOperationType sourceConcatenatedOperation;
                sourceConcatenatedOperation = this.getConcatenatedOperation();
                ConcatenatedOperationType copyConcatenatedOperation = ((ConcatenatedOperationType) strategy.copy(LocatorUtils.property(locator, "concatenatedOperation", sourceConcatenatedOperation), sourceConcatenatedOperation));
                copy.setConcatenatedOperation(copyConcatenatedOperation);
            } else {
                copy.concatenatedOperation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ConcatenatedOperationPropertyType) {
            final ConcatenatedOperationPropertyType target = this;
            final ConcatenatedOperationPropertyType leftObject = ((ConcatenatedOperationPropertyType) left);
            final ConcatenatedOperationPropertyType rightObject = ((ConcatenatedOperationPropertyType) right);
            {
                ConcatenatedOperationType lhsConcatenatedOperation;
                lhsConcatenatedOperation = leftObject.getConcatenatedOperation();
                ConcatenatedOperationType rhsConcatenatedOperation;
                rhsConcatenatedOperation = rightObject.getConcatenatedOperation();
                target.setConcatenatedOperation(((ConcatenatedOperationType) strategy.merge(LocatorUtils.property(leftLocator, "concatenatedOperation", lhsConcatenatedOperation), LocatorUtils.property(rightLocator, "concatenatedOperation", rhsConcatenatedOperation), lhsConcatenatedOperation, rhsConcatenatedOperation)));
            }
            {
                List<String> lhsNilReason;
