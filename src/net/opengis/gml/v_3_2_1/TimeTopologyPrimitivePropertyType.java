 ...
 * 
 * <p>Java-Klasse für TimeTopologyPrimitivePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractTimeTopologyPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractTimeTopologyPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractTimeTopologyPrimitiveType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theAbstractTimeTopologyPrimitive;
            theAbstractTimeTopologyPrimitive = this.getAbstractTimeTopologyPrimitive();
            strategy.appendField(locator, this, "abstractTimeTopologyPrimitive", buffer, theAbstractTimeTopologyPrimitive);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TimeTopologyPrimitivePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeTopologyPrimitivePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeTopologyPrimitivePropertyType that = ((TimeTopologyPrimitivePropertyType) object);
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsAbstractTimeTopologyPrimitive;
            lhsAbstractTimeTopologyPrimitive = this.getAbstractTimeTopologyPrimitive();
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> rhsAbstractTimeTopologyPrimitive;
            rhsAbstractTimeTopologyPrimitive = that.getAbstractTimeTopologyPrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractTimeTopologyPrimitive", lhsAbstractTimeTopologyPrimitive), LocatorUtils.property(thatLocator, "abstractTimeTopologyPrimitive", rhsAbstractTimeTopologyPrimitive), lhsAbstractTimeTopologyPrimitive, rhsAbstractTimeTopologyPrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimeTopologyPrimitiveType> theAbstractTimeTopologyPrimitive;
            theAbstractTimeTopologyPrimitive = this.getAbstractTimeTopologyPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractTimeTopologyPrimitive", theAbstractTimeTopologyPrimitive), currentHashCode, theAbstractTimeTopologyPrimitive);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeTopologyPrimitivePropertyType) {
            final TimeTopologyPrimitivePropertyType copy = ((TimeTopologyPrimitivePropertyType) draftCopy);
            if (this.isSetAbstractTimeTopologyPrimitive()) {
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> sourceAbstractTimeTopologyPrimitive;
                sourceAbstractTimeTopologyPrimitive = this.getAbstractTimeTopologyPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> copyAbstractTimeTopologyPrimitive = ((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTimeTopologyPrimitive", sourceAbstractTimeTopologyPrimitive), sourceAbstractTimeTopologyPrimitive));
                copy.setAbstractTimeTopologyPrimitive(copyAbstractTimeTopologyPrimitive);
            } else {
                copy.abstractTimeTopologyPrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeTopologyPrimitivePropertyType) {
            final TimeTopologyPrimitivePropertyType target = this;
            final TimeTopologyPrimitivePropertyType leftObject = ((TimeTopologyPrimitivePropertyType) left);
            final TimeTopologyPrimitivePropertyType rightObject = ((TimeTopologyPrimitivePropertyType) right);
            {
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> lhsAbstractTimeTopologyPrimitive;
                lhsAbstractTimeTopologyPrimitive = leftObject.getAbstractTimeTopologyPrimitive();
                JAXBElement<? extends AbstractTimeTopologyPrimitiveType> rhsAbstractTimeTopologyPrimitive;
                rhsAbstractTimeTopologyPrimitive = rightObject.getAbstractTimeTopologyPrimitive();
                target.setAbstractTimeTopologyPrimitive(((JAXBElement<? extends AbstractTimeTopologyPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTimeTopologyPrimitive", lhsAbstractTimeTopologyPrimitive), LocatorUtils.property(rightLocator, "abstractTimeTopologyPrimitive", rhsAbstractTimeTopologyPrimitive), lhsAbstractTimeTopologyPrimitive, rhsAbstractTimeTopologyPrimitive)));
            }
            {
                List<String> lhsNilReason;
