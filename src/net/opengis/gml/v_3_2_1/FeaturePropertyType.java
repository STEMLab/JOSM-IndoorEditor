    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = FeaturePropertyType.TYPE;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FeaturePropertyType) {
            final FeaturePropertyType copy = ((FeaturePropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof FeaturePropertyType) {
            final FeaturePropertyType target = this;
            final FeaturePropertyType leftObject = ((FeaturePropertyType) left);
            final FeaturePropertyType rightObject = ((FeaturePropertyType) right);
            {
                JAXBElement<? extends AbstractFeatureType> lhsAbstractFeature;
