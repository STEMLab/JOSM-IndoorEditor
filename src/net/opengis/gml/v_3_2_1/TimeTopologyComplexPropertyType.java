 ...
 * 
 * <p>Java-Klasse für TimeTopologyComplexPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeTopologyComplex-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeTopologyComplex-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeTopologyComplexType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeTopologyComplexType theTimeTopologyComplex;
            theTimeTopologyComplex = this.getTimeTopologyComplex();
            strategy.appendField(locator, this, "timeTopologyComplex", buffer, theTimeTopologyComplex);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = TimeTopologyComplexPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeTopologyComplexPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            TimeTopologyComplexType lhsTimeTopologyComplex;
            lhsTimeTopologyComplex = this.getTimeTopologyComplex();
            TimeTopologyComplexType rhsTimeTopologyComplex;
            rhsTimeTopologyComplex = that.getTimeTopologyComplex();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeTopologyComplex", lhsTimeTopologyComplex), LocatorUtils.property(thatLocator, "timeTopologyComplex", rhsTimeTopologyComplex), lhsTimeTopologyComplex, rhsTimeTopologyComplex)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeTopologyComplexType theTimeTopologyComplex;
            theTimeTopologyComplex = this.getTimeTopologyComplex();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeTopologyComplex", theTimeTopologyComplex), currentHashCode, theTimeTopologyComplex);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeTopologyComplexPropertyType) {
            final TimeTopologyComplexPropertyType copy = ((TimeTopologyComplexPropertyType) draftCopy);
            if (this.isSetTimeTopologyComplex()) {
                TimeTopologyComplexType sourceTimeTopologyComplex;
                sourceTimeTopologyComplex = this.getTimeTopologyComplex();
                TimeTopologyComplexType copyTimeTopologyComplex = ((TimeTopologyComplexType) strategy.copy(LocatorUtils.property(locator, "timeTopologyComplex", sourceTimeTopologyComplex), sourceTimeTopologyComplex));
                copy.setTimeTopologyComplex(copyTimeTopologyComplex);
            } else {
                copy.timeTopologyComplex = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeTopologyComplexPropertyType) {
            final TimeTopologyComplexPropertyType target = this;
            final TimeTopologyComplexPropertyType leftObject = ((TimeTopologyComplexPropertyType) left);
            final TimeTopologyComplexPropertyType rightObject = ((TimeTopologyComplexPropertyType) right);
            {
                TimeTopologyComplexType lhsTimeTopologyComplex;
                lhsTimeTopologyComplex = leftObject.getTimeTopologyComplex();
                TimeTopologyComplexType rhsTimeTopologyComplex;
                rhsTimeTopologyComplex = rightObject.getTimeTopologyComplex();
                target.setTimeTopologyComplex(((TimeTopologyComplexType) strategy.merge(LocatorUtils.property(leftLocator, "timeTopologyComplex", lhsTimeTopologyComplex), LocatorUtils.property(rightLocator, "timeTopologyComplex", rhsTimeTopologyComplex), lhsTimeTopologyComplex, rhsTimeTopologyComplex)));
            }
            {
                boolean lhsOwns;
