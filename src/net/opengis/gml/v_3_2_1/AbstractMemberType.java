 ...
 * 
 * 
 * <p>Java-Klasse für AbstractMemberType complex type.
 * 
...
public abstract class AbstractMemberType implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AbstractMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AbstractMemberType that = ((AbstractMemberType) object);
        {
            boolean lhsOwns;
            lhsOwns = this.isOwns();
            boolean rhsOwns;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (target instanceof AbstractMemberType) {
            final AbstractMemberType copy = ((AbstractMemberType) target);
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AbstractMemberType) {
            final AbstractMemberType target = this;
            final AbstractMemberType leftObject = ((AbstractMemberType) left);
            final AbstractMemberType rightObject = ((AbstractMemberType) right);
            {
                boolean lhsOwns;
