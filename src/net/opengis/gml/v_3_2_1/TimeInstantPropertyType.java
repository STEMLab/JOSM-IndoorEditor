 ...
 * 
 * <p>Java-Klasse für TimeInstantPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "timeInstant", buffer, theTimeInstant);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TimeInstantPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TimeInstantPropertyType that = ((TimeInstantPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeInstant", lhsTimeInstant), LocatorUtils.property(thatLocator, "timeInstant", rhsTimeInstant), lhsTimeInstant, rhsTimeInstant)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeInstantType theTimeInstant;
            theTimeInstant = this.getTimeInstant();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeInstant", theTimeInstant), currentHashCode, theTimeInstant);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeInstantPropertyType) {
            final TimeInstantPropertyType copy = ((TimeInstantPropertyType) draftCopy);
            if (this.isSetTimeInstant()) {
                TimeInstantType sourceTimeInstant;
                sourceTimeInstant = this.getTimeInstant();
                TimeInstantType copyTimeInstant = ((TimeInstantType) strategy.copy(LocatorUtils.property(locator, "timeInstant", sourceTimeInstant), sourceTimeInstant));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeInstantPropertyType) {
            final TimeInstantPropertyType target = this;
            final TimeInstantPropertyType leftObject = ((TimeInstantPropertyType) left);
            final TimeInstantPropertyType rightObject = ((TimeInstantPropertyType) right);
            {
                TimeInstantType lhsTimeInstant;
                lhsTimeInstant = leftObject.getTimeInstant();
                TimeInstantType rhsTimeInstant;
                rhsTimeInstant = rightObject.getTimeInstant();
                target.setTimeInstant(((TimeInstantType) strategy.merge(LocatorUtils.property(leftLocator, "timeInstant", lhsTimeInstant), LocatorUtils.property(rightLocator, "timeInstant", rhsTimeInstant), lhsTimeInstant, rhsTimeInstant)));
            }
            {
                List<String> lhsNilReason;
