...
/**
 * <p>Java-Klasse für ObliqueCartesianCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der obliqueCartesianCS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der obliqueCartesianCS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ObliqueCartesianCSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ObliqueCartesianCSType theObliqueCartesianCS;
            theObliqueCartesianCS = this.getObliqueCartesianCS();
            strategy.appendField(locator, this, "obliqueCartesianCS", buffer, theObliqueCartesianCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ObliqueCartesianCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObliqueCartesianCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObliqueCartesianCSPropertyType that = ((ObliqueCartesianCSPropertyType) object);
        {
            ObliqueCartesianCSType lhsObliqueCartesianCS;
            lhsObliqueCartesianCS = this.getObliqueCartesianCS();
            ObliqueCartesianCSType rhsObliqueCartesianCS;
            rhsObliqueCartesianCS = that.getObliqueCartesianCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "obliqueCartesianCS", lhsObliqueCartesianCS), LocatorUtils.property(thatLocator, "obliqueCartesianCS", rhsObliqueCartesianCS), lhsObliqueCartesianCS, rhsObliqueCartesianCS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ObliqueCartesianCSType theObliqueCartesianCS;
            theObliqueCartesianCS = this.getObliqueCartesianCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "obliqueCartesianCS", theObliqueCartesianCS), currentHashCode, theObliqueCartesianCS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ObliqueCartesianCSPropertyType) {
            final ObliqueCartesianCSPropertyType copy = ((ObliqueCartesianCSPropertyType) draftCopy);
            if (this.isSetObliqueCartesianCS()) {
                ObliqueCartesianCSType sourceObliqueCartesianCS;
                sourceObliqueCartesianCS = this.getObliqueCartesianCS();
                ObliqueCartesianCSType copyObliqueCartesianCS = ((ObliqueCartesianCSType) strategy.copy(LocatorUtils.property(locator, "obliqueCartesianCS", sourceObliqueCartesianCS), sourceObliqueCartesianCS));
                copy.setObliqueCartesianCS(copyObliqueCartesianCS);
            } else {
                copy.obliqueCartesianCS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ObliqueCartesianCSPropertyType) {
            final ObliqueCartesianCSPropertyType target = this;
            final ObliqueCartesianCSPropertyType leftObject = ((ObliqueCartesianCSPropertyType) left);
            final ObliqueCartesianCSPropertyType rightObject = ((ObliqueCartesianCSPropertyType) right);
            {
                ObliqueCartesianCSType lhsObliqueCartesianCS;
                lhsObliqueCartesianCS = leftObject.getObliqueCartesianCS();
                ObliqueCartesianCSType rhsObliqueCartesianCS;
                rhsObliqueCartesianCS = rightObject.getObliqueCartesianCS();
                target.setObliqueCartesianCS(((ObliqueCartesianCSType) strategy.merge(LocatorUtils.property(leftLocator, "obliqueCartesianCS", lhsObliqueCartesianCS), LocatorUtils.property(rightLocator, "obliqueCartesianCS", rhsObliqueCartesianCS), lhsObliqueCartesianCS, rhsObliqueCartesianCS)));
            }
            {
                List<String> lhsNilReason;
