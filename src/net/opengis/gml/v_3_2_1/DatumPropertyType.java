 ...
 * 
 * <p>Java-Klasse für DatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractDatum", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractDatum-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractDatum-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link VerticalDatumType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractDatumType> theAbstractDatum;
            theAbstractDatum = this.getAbstractDatum();
            strategy.appendField(locator, this, "abstractDatum", buffer, theAbstractDatum);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            JAXBElement<? extends AbstractDatumType> lhsAbstractDatum;
            lhsAbstractDatum = this.getAbstractDatum();
            JAXBElement<? extends AbstractDatumType> rhsAbstractDatum;
            rhsAbstractDatum = that.getAbstractDatum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDatum", lhsAbstractDatum), LocatorUtils.property(thatLocator, "abstractDatum", rhsAbstractDatum), lhsAbstractDatum, rhsAbstractDatum)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractDatumType> theAbstractDatum;
            theAbstractDatum = this.getAbstractDatum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDatum", theAbstractDatum), currentHashCode, theAbstractDatum);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DatumPropertyType) {
            final DatumPropertyType copy = ((DatumPropertyType) draftCopy);
            if (this.isSetAbstractDatum()) {
                JAXBElement<? extends AbstractDatumType> sourceAbstractDatum;
                sourceAbstractDatum = this.getAbstractDatum();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractDatumType> copyAbstractDatum = ((JAXBElement<? extends AbstractDatumType> ) strategy.copy(LocatorUtils.property(locator, "abstractDatum", sourceAbstractDatum), sourceAbstractDatum));
                copy.setAbstractDatum(copyAbstractDatum);
            } else {
                copy.abstractDatum = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DatumPropertyType) {
            final DatumPropertyType target = this;
            final DatumPropertyType leftObject = ((DatumPropertyType) left);
            final DatumPropertyType rightObject = ((DatumPropertyType) right);
            {
                JAXBElement<? extends AbstractDatumType> lhsAbstractDatum;
                lhsAbstractDatum = leftObject.getAbstractDatum();
                JAXBElement<? extends AbstractDatumType> rhsAbstractDatum;
                rhsAbstractDatum = rightObject.getAbstractDatum();
                target.setAbstractDatum(((JAXBElement<? extends AbstractDatumType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractDatum", lhsAbstractDatum), LocatorUtils.property(rightLocator, "abstractDatum", rhsAbstractDatum), lhsAbstractDatum, rhsAbstractDatum)));
            }
            {
                List<String> lhsNilReason;
