 ...
 * 
 * <p>Java-Klasse für TimePrimitivePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractTimePrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractTimePrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimePeriodType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theAbstractTimePrimitive;
            theAbstractTimePrimitive = this.getAbstractTimePrimitive();
            strategy.appendField(locator, this, "abstractTimePrimitive", buffer, theAbstractTimePrimitive);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TimePrimitivePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimePrimitivePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimePrimitivePropertyType that = ((TimePrimitivePropertyType) object);
        {
            JAXBElement<? extends AbstractTimePrimitiveType> lhsAbstractTimePrimitive;
            lhsAbstractTimePrimitive = this.getAbstractTimePrimitive();
            JAXBElement<? extends AbstractTimePrimitiveType> rhsAbstractTimePrimitive;
            rhsAbstractTimePrimitive = that.getAbstractTimePrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractTimePrimitive", lhsAbstractTimePrimitive), LocatorUtils.property(thatLocator, "abstractTimePrimitive", rhsAbstractTimePrimitive), lhsAbstractTimePrimitive, rhsAbstractTimePrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractTimePrimitiveType> theAbstractTimePrimitive;
            theAbstractTimePrimitive = this.getAbstractTimePrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractTimePrimitive", theAbstractTimePrimitive), currentHashCode, theAbstractTimePrimitive);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimePrimitivePropertyType) {
            final TimePrimitivePropertyType copy = ((TimePrimitivePropertyType) draftCopy);
            if (this.isSetAbstractTimePrimitive()) {
                JAXBElement<? extends AbstractTimePrimitiveType> sourceAbstractTimePrimitive;
                sourceAbstractTimePrimitive = this.getAbstractTimePrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTimePrimitiveType> copyAbstractTimePrimitive = ((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTimePrimitive", sourceAbstractTimePrimitive), sourceAbstractTimePrimitive));
                copy.setAbstractTimePrimitive(copyAbstractTimePrimitive);
            } else {
                copy.abstractTimePrimitive = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimePrimitivePropertyType) {
            final TimePrimitivePropertyType target = this;
            final TimePrimitivePropertyType leftObject = ((TimePrimitivePropertyType) left);
            final TimePrimitivePropertyType rightObject = ((TimePrimitivePropertyType) right);
            {
                JAXBElement<? extends AbstractTimePrimitiveType> lhsAbstractTimePrimitive;
                lhsAbstractTimePrimitive = leftObject.getAbstractTimePrimitive();
                JAXBElement<? extends AbstractTimePrimitiveType> rhsAbstractTimePrimitive;
                rhsAbstractTimePrimitive = rightObject.getAbstractTimePrimitive();
                target.setAbstractTimePrimitive(((JAXBElement<? extends AbstractTimePrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTimePrimitive", lhsAbstractTimePrimitive), LocatorUtils.property(rightLocator, "abstractTimePrimitive", rhsAbstractTimePrimitive), lhsAbstractTimePrimitive, rhsAbstractTimePrimitive)));
            }
            {
                List<String> lhsNilReason;
