 ...
 * 
 * <p>Java-Klasse für TimePeriodPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = TimePeriodPropertyType.TYPE;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimePeriodPropertyType) {
            final TimePeriodPropertyType copy = ((TimePeriodPropertyType) draftCopy);
            if (this.isSetTimePeriod()) {
                TimePeriodType sourceTimePeriod;
                sourceTimePeriod = this.getTimePeriod();
                TimePeriodType copyTimePeriod = ((TimePeriodType) strategy.copy(LocatorUtils.property(locator, "timePeriod", sourceTimePeriod), sourceTimePeriod));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimePeriodPropertyType) {
            final TimePeriodPropertyType target = this;
            final TimePeriodPropertyType leftObject = ((TimePeriodPropertyType) left);
            final TimePeriodPropertyType rightObject = ((TimePeriodPropertyType) right);
            {
                TimePeriodType lhsTimePeriod;
                lhsTimePeriod = leftObject.getTimePeriod();
                TimePeriodType rhsTimePeriod;
                rhsTimePeriod = rightObject.getTimePeriod();
                target.setTimePeriod(((TimePeriodType) strategy.merge(LocatorUtils.property(leftLocator, "timePeriod", lhsTimePeriod), LocatorUtils.property(rightLocator, "timePeriod", rhsTimePeriod), lhsTimePeriod, rhsTimePeriod)));
            }
            {
                List<String> lhsNilReason;
