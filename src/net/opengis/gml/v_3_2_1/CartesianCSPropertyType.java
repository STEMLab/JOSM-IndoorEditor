 ...
 * 
 * <p>Java-Klasse für CartesianCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CartesianCSType theCartesianCS;
        ...
        {
            String theTYPE;
            theTYPE = CartesianCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CartesianCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CartesianCSPropertyType that = ((CartesianCSPropertyType) object);
        {
            CartesianCSType lhsCartesianCS;
            lhsCartesianCS = this.getCartesianCS();
            CartesianCSType rhsCartesianCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CartesianCSPropertyType) {
            final CartesianCSPropertyType copy = ((CartesianCSPropertyType) draftCopy);
            if (this.isSetCartesianCS()) {
                CartesianCSType sourceCartesianCS;
                sourceCartesianCS = this.getCartesianCS();
                CartesianCSType copyCartesianCS = ((CartesianCSType) strategy.copy(LocatorUtils.property(locator, "cartesianCS", sourceCartesianCS), sourceCartesianCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CartesianCSPropertyType) {
            final CartesianCSPropertyType target = this;
            final CartesianCSPropertyType leftObject = ((CartesianCSPropertyType) left);
            final CartesianCSPropertyType rightObject = ((CartesianCSPropertyType) right);
            {
                CartesianCSType lhsCartesianCS;
                lhsCartesianCS = leftObject.getCartesianCS();
                CartesianCSType rhsCartesianCS;
                rhsCartesianCS = rightObject.getCartesianCS();
                target.setCartesianCS(((CartesianCSType) strategy.merge(LocatorUtils.property(leftLocator, "cartesianCS", lhsCartesianCS), LocatorUtils.property(rightLocator, "cartesianCS", rhsCartesianCS), lhsCartesianCS, rhsCartesianCS)));
            }
            {
                List<String> lhsNilReason;
