 ...
 * 
 * <p>Java-Klasse für CRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractCRS", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ImageCRSType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCRSType> theAbstractCRS;
            theAbstractCRS = this.getAbstractCRS();
            strategy.appendField(locator, this, "abstractCRS", buffer, theAbstractCRS);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CRSPropertyType that = ((CRSPropertyType) object);
        {
            JAXBElement<? extends AbstractCRSType> lhsAbstractCRS;
            lhsAbstractCRS = this.getAbstractCRS();
            JAXBElement<? extends AbstractCRSType> rhsAbstractCRS;
            rhsAbstractCRS = that.getAbstractCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(thatLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCRSType> theAbstractCRS;
            theAbstractCRS = this.getAbstractCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractCRS", theAbstractCRS), currentHashCode, theAbstractCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CRSPropertyType) {
            final CRSPropertyType copy = ((CRSPropertyType) draftCopy);
            if (this.isSetAbstractCRS()) {
                JAXBElement<? extends AbstractCRSType> sourceAbstractCRS;
                sourceAbstractCRS = this.getAbstractCRS();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCRSType> copyAbstractCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.copy(LocatorUtils.property(locator, "abstractCRS", sourceAbstractCRS), sourceAbstractCRS));
                copy.setAbstractCRS(copyAbstractCRS);
            } else {
                copy.abstractCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CRSPropertyType) {
            final CRSPropertyType target = this;
            final CRSPropertyType leftObject = ((CRSPropertyType) left);
            final CRSPropertyType rightObject = ((CRSPropertyType) right);
            {
                JAXBElement<? extends AbstractCRSType> lhsAbstractCRS;
                lhsAbstractCRS = leftObject.getAbstractCRS();
                JAXBElement<? extends AbstractCRSType> rhsAbstractCRS;
                rhsAbstractCRS = rightObject.getAbstractCRS();
                target.setAbstractCRS(((JAXBElement<? extends AbstractCRSType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(rightLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS)));
            }
            {
                List<String> lhsNilReason;
