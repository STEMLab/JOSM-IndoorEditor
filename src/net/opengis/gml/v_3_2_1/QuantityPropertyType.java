...
/**
 * <p>Java-Klasse für QuantityPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = QuantityPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof QuantityPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final QuantityPropertyType that = ((QuantityPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof QuantityPropertyType) {
            final QuantityPropertyType copy = ((QuantityPropertyType) draftCopy);
            if (this.isSetQuantity()) {
                Quantity sourceQuantity;
                sourceQuantity = this.getQuantity();
                Quantity copyQuantity = ((Quantity) strategy.copy(LocatorUtils.property(locator, "quantity", sourceQuantity), sourceQuantity));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof QuantityPropertyType) {
            final QuantityPropertyType target = this;
            final QuantityPropertyType leftObject = ((QuantityPropertyType) left);
            final QuantityPropertyType rightObject = ((QuantityPropertyType) right);
            {
                Quantity lhsQuantity;
                lhsQuantity = leftObject.getQuantity();
                Quantity rhsQuantity;
                rhsQuantity = rightObject.getQuantity();
                target.setQuantity(((Quantity) strategy.merge(LocatorUtils.property(leftLocator, "quantity", lhsQuantity), LocatorUtils.property(rightLocator, "quantity", rhsQuantity), lhsQuantity, rhsQuantity)));
            }
            {
                List<String> lhsNilReason;
