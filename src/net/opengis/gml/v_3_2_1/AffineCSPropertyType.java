 ...
 * 
 * <p>Java-Klasse für AffineCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = AffineCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AffineCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AffineCSPropertyType that = ((AffineCSPropertyType) object);
        {
            AffineCSType lhsAffineCS;
            lhsAffineCS = this.getAffineCS();
            AffineCSType rhsAffineCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AffineCSPropertyType) {
            final AffineCSPropertyType copy = ((AffineCSPropertyType) draftCopy);
            if (this.isSetAffineCS()) {
                AffineCSType sourceAffineCS;
                sourceAffineCS = this.getAffineCS();
                AffineCSType copyAffineCS = ((AffineCSType) strategy.copy(LocatorUtils.property(locator, "affineCS", sourceAffineCS), sourceAffineCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AffineCSPropertyType) {
            final AffineCSPropertyType target = this;
            final AffineCSPropertyType leftObject = ((AffineCSPropertyType) left);
            final AffineCSPropertyType rightObject = ((AffineCSPropertyType) right);
            {
                AffineCSType lhsAffineCS;
                lhsAffineCS = leftObject.getAffineCS();
                AffineCSType rhsAffineCS;
                rhsAffineCS = rightObject.getAffineCS();
                target.setAffineCS(((AffineCSType) strategy.merge(LocatorUtils.property(leftLocator, "affineCS", lhsAffineCS), LocatorUtils.property(rightLocator, "affineCS", rhsAffineCS), lhsAffineCS, rhsAffineCS)));
            }
            {
                List<String> lhsNilReason;
