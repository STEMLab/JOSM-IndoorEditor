 ...
 * 
 * <p>Java-Klasse für MultiGeometryPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractGeometricAggregate-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractGeometricAggregate-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MultiSolidType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeometricAggregateType> theAbstractGeometricAggregate;
            theAbstractGeometricAggregate = this.getAbstractGeometricAggregate();
            strategy.appendField(locator, this, "abstractGeometricAggregate", buffer, theAbstractGeometricAggregate);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MultiGeometryPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractGeometricAggregateType> lhsAbstractGeometricAggregate;
            lhsAbstractGeometricAggregate = this.getAbstractGeometricAggregate();
            JAXBElement<? extends AbstractGeometricAggregateType> rhsAbstractGeometricAggregate;
            rhsAbstractGeometricAggregate = that.getAbstractGeometricAggregate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractGeometricAggregate", lhsAbstractGeometricAggregate), LocatorUtils.property(thatLocator, "abstractGeometricAggregate", rhsAbstractGeometricAggregate), lhsAbstractGeometricAggregate, rhsAbstractGeometricAggregate)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricAggregateType> theAbstractGeometricAggregate;
            theAbstractGeometricAggregate = this.getAbstractGeometricAggregate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractGeometricAggregate", theAbstractGeometricAggregate), currentHashCode, theAbstractGeometricAggregate);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MultiGeometryPropertyType) {
            ...
            if (this.isSetAbstractGeometricAggregate()) {
                JAXBElement<? extends AbstractGeometricAggregateType> sourceAbstractGeometricAggregate;
                sourceAbstractGeometricAggregate = this.getAbstractGeometricAggregate();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeometricAggregateType> copyAbstractGeometricAggregate = ((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.copy(LocatorUtils.property(locator, "abstractGeometricAggregate", sourceAbstractGeometricAggregate), sourceAbstractGeometricAggregate));
                copy.setAbstractGeometricAggregate(copyAbstractGeometricAggregate);
            } else {
                copy.abstractGeometricAggregate = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiGeometryPropertyType) {
            final MultiGeometryPropertyType target = this;
            final MultiGeometryPropertyType leftObject = ((MultiGeometryPropertyType) left);
            final MultiGeometryPropertyType rightObject = ((MultiGeometryPropertyType) right);
            {
                JAXBElement<? extends AbstractGeometricAggregateType> lhsAbstractGeometricAggregate;
                lhsAbstractGeometricAggregate = leftObject.getAbstractGeometricAggregate();
                JAXBElement<? extends AbstractGeometricAggregateType> rhsAbstractGeometricAggregate;
                rhsAbstractGeometricAggregate = rightObject.getAbstractGeometricAggregate();
                target.setAbstractGeometricAggregate(((JAXBElement<? extends AbstractGeometricAggregateType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractGeometricAggregate", lhsAbstractGeometricAggregate), LocatorUtils.property(rightLocator, "abstractGeometricAggregate", rhsAbstractGeometricAggregate), lhsAbstractGeometricAggregate, rhsAbstractGeometricAggregate)));
            }
            {
                List<String> lhsNilReason;
