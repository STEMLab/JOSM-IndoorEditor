    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der ciCitation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Element }
    ...
    /**
     * Legt den Wert der ciCitation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Element }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            Element theCICitation;
            theCICitation = this.getCICitation();
            strategy.appendField(locator, this, "ciCitation", buffer, theCICitation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = FormulaCitationElement.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FormulaCitationElement)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FormulaCitationElement that = ((FormulaCitationElement) object);
        {
            Element lhsCICitation;
            lhsCICitation = this.getCICitation();
            Element rhsCICitation;
            rhsCICitation = that.getCICitation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ciCitation", lhsCICitation), LocatorUtils.property(thatLocator, "ciCitation", rhsCICitation), lhsCICitation, rhsCICitation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            Element theCICitation;
            theCICitation = this.getCICitation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ciCitation", theCICitation), currentHashCode, theCICitation);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FormulaCitationElement) {
            final FormulaCitationElement copy = ((FormulaCitationElement) draftCopy);
            if (this.isSetCICitation()) {
                Element sourceCICitation;
                sourceCICitation = this.getCICitation();
                Element copyCICitation = ((Element) strategy.copy(LocatorUtils.property(locator, "ciCitation", sourceCICitation), sourceCICitation));
                copy.setCICitation(copyCICitation);
            } else {
                copy.ciCitation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof FormulaCitationElement) {
            final FormulaCitationElement target = this;
            final FormulaCitationElement leftObject = ((FormulaCitationElement) left);
            final FormulaCitationElement rightObject = ((FormulaCitationElement) right);
            {
                Element lhsCICitation;
                lhsCICitation = leftObject.getCICitation();
                Element rhsCICitation;
                rhsCICitation = rightObject.getCICitation();
                target.setCICitation(((Element) strategy.merge(LocatorUtils.property(leftLocator, "ciCitation", lhsCICitation), LocatorUtils.property(rightLocator, "ciCitation", rhsCICitation), lhsCICitation, rhsCICitation)));
            }
            {
                List<String> lhsNilReason;
