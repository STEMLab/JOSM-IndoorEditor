...
public class Boolean implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof Boolean) {
            ...
            final Boolean rightObject = ((Boolean) right);
            {
                ...
                target.setValue(((boolean) strategy.merge(LocatorUtils.property(leftLocator, "value", lhsValue), LocatorUtils.property(rightLocator, "value", rhsValue), lhsValue, rhsValue)));
            }
            {
                List<String> lhsNilReason;
