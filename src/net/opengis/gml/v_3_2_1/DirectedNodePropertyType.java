...
/**
 * <p>Java-Klasse für DirectedNodePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = DirectedNodePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DirectedNodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DirectedNodePropertyType that = ((DirectedNodePropertyType) object);
        {
            NodeType lhsNode;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DirectedNodePropertyType) {
            final DirectedNodePropertyType copy = ((DirectedNodePropertyType) draftCopy);
            if (this.isSetNode()) {
                NodeType sourceNode;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DirectedNodePropertyType) {
            final DirectedNodePropertyType target = this;
            final DirectedNodePropertyType leftObject = ((DirectedNodePropertyType) left);
            final DirectedNodePropertyType rightObject = ((DirectedNodePropertyType) right);
            {
                NodeType lhsNode;
