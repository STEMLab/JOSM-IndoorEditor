 ...
 * 
 * <p>Java-Klasse für GeneralTransformationPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractGeneralTransformation", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractGeneralTransformation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractGeneralTransformation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TransformationType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeneralTransformationType> theAbstractGeneralTransformation;
            theAbstractGeneralTransformation = this.getAbstractGeneralTransformation();
            strategy.appendField(locator, this, "abstractGeneralTransformation", buffer, theAbstractGeneralTransformation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = GeneralTransformationPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeneralTransformationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeneralTransformationPropertyType that = ((GeneralTransformationPropertyType) object);
        {
            JAXBElement<? extends AbstractGeneralTransformationType> lhsAbstractGeneralTransformation;
            lhsAbstractGeneralTransformation = this.getAbstractGeneralTransformation();
            JAXBElement<? extends AbstractGeneralTransformationType> rhsAbstractGeneralTransformation;
            rhsAbstractGeneralTransformation = that.getAbstractGeneralTransformation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractGeneralTransformation", lhsAbstractGeneralTransformation), LocatorUtils.property(thatLocator, "abstractGeneralTransformation", rhsAbstractGeneralTransformation), lhsAbstractGeneralTransformation, rhsAbstractGeneralTransformation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeneralTransformationType> theAbstractGeneralTransformation;
            theAbstractGeneralTransformation = this.getAbstractGeneralTransformation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractGeneralTransformation", theAbstractGeneralTransformation), currentHashCode, theAbstractGeneralTransformation);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeneralTransformationPropertyType) {
            final GeneralTransformationPropertyType copy = ((GeneralTransformationPropertyType) draftCopy);
            if (this.isSetAbstractGeneralTransformation()) {
                JAXBElement<? extends AbstractGeneralTransformationType> sourceAbstractGeneralTransformation;
                sourceAbstractGeneralTransformation = this.getAbstractGeneralTransformation();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeneralTransformationType> copyAbstractGeneralTransformation = ((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.copy(LocatorUtils.property(locator, "abstractGeneralTransformation", sourceAbstractGeneralTransformation), sourceAbstractGeneralTransformation));
                copy.setAbstractGeneralTransformation(copyAbstractGeneralTransformation);
            } else {
                copy.abstractGeneralTransformation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeneralTransformationPropertyType) {
            final GeneralTransformationPropertyType target = this;
            final GeneralTransformationPropertyType leftObject = ((GeneralTransformationPropertyType) left);
            final GeneralTransformationPropertyType rightObject = ((GeneralTransformationPropertyType) right);
            {
                JAXBElement<? extends AbstractGeneralTransformationType> lhsAbstractGeneralTransformation;
                lhsAbstractGeneralTransformation = leftObject.getAbstractGeneralTransformation();
                JAXBElement<? extends AbstractGeneralTransformationType> rhsAbstractGeneralTransformation;
                rhsAbstractGeneralTransformation = rightObject.getAbstractGeneralTransformation();
                target.setAbstractGeneralTransformation(((JAXBElement<? extends AbstractGeneralTransformationType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractGeneralTransformation", lhsAbstractGeneralTransformation), LocatorUtils.property(rightLocator, "abstractGeneralTransformation", rhsAbstractGeneralTransformation), lhsAbstractGeneralTransformation, rhsAbstractGeneralTransformation)));
            }
            {
                List<String> lhsNilReason;
