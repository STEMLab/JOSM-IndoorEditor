    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractValue-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractValue-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link CompositeValueType }{@code >}
    ...
    /**
     * Ruft den Wert der abstractTimeObject-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractTimeObject-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TimeTopologyComplexType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ...
            strategy.appendField(locator, this, "abstractValue", buffer, theAbstractValue);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ValuePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ValuePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ValuePropertyType that = ((ValuePropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractValue", lhsAbstractValue), LocatorUtils.property(thatLocator, "abstractValue", rhsAbstractValue), lhsAbstractValue, rhsAbstractValue)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<?> theAbstractValue;
            theAbstractValue = this.getAbstractValue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractValue", theAbstractValue), currentHashCode, theAbstractValue);
        }
        {
            JAXBElement<? extends AbstractGeometryType> theAbstractGeometry;
            theAbstractGeometry = this.getAbstractGeometry();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ValuePropertyType) {
            ...
            if (this.isSetAbstractValue()) {
                JAXBElement<?> sourceAbstractValue;
                sourceAbstractValue = this.getAbstractValue();
                @SuppressWarnings("unchecked")
                JAXBElement<?> copyAbstractValue = ((JAXBElement<?> ) strategy.copy(LocatorUtils.property(locator, "abstractValue", sourceAbstractValue), sourceAbstractValue));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ValuePropertyType) {
            ...
            final ValuePropertyType rightObject = ((ValuePropertyType) right);
            {
                ...
                target.setAbstractValue(((JAXBElement<?> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractValue", lhsAbstractValue), LocatorUtils.property(rightLocator, "abstractValue", rhsAbstractValue), lhsAbstractValue, rhsAbstractValue)));
            }
            {
                JAXBElement<? extends AbstractGeometryType> lhsAbstractGeometry;
