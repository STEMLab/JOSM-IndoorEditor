    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = AssociationRoleType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AssociationRoleType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AssociationRoleType that = ((AssociationRoleType) object);
        {
            Object lhsAny;
            lhsAny = this.getAny();
            Object rhsAny;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AssociationRoleType) {
            final AssociationRoleType copy = ((AssociationRoleType) draftCopy);
            if (this.isSetAny()) {
                Object sourceAny;
                sourceAny = this.getAny();
                Object copyAny = ((Object) strategy.copy(LocatorUtils.property(locator, "any", sourceAny), sourceAny));
                copy.setAny(copyAny);
            } else {
                copy.any = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AssociationRoleType) {
            final AssociationRoleType target = this;
            final AssociationRoleType leftObject = ((AssociationRoleType) left);
            final AssociationRoleType rightObject = ((AssociationRoleType) right);
            {
                Object lhsAny;
                lhsAny = leftObject.getAny();
                Object rhsAny;
                rhsAny = rightObject.getAny();
                target.setAny(((Object) strategy.merge(LocatorUtils.property(leftLocator, "any", lhsAny), LocatorUtils.property(rightLocator, "any", rhsAny), lhsAny, rhsAny)));
            }
            {
                boolean lhsOwns;
