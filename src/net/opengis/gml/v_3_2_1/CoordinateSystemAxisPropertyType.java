 ...
 * 
 * <p>Java-Klasse für CoordinateSystemAxisPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der coordinateSystemAxis-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der coordinateSystemAxis-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link CoordinateSystemAxisType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CoordinateSystemAxisType theCoordinateSystemAxis;
            theCoordinateSystemAxis = this.getCoordinateSystemAxis();
            strategy.appendField(locator, this, "coordinateSystemAxis", buffer, theCoordinateSystemAxis);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CoordinateSystemAxisPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CoordinateSystemAxisPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CoordinateSystemAxisPropertyType that = ((CoordinateSystemAxisPropertyType) object);
        {
            CoordinateSystemAxisType lhsCoordinateSystemAxis;
            lhsCoordinateSystemAxis = this.getCoordinateSystemAxis();
            CoordinateSystemAxisType rhsCoordinateSystemAxis;
            rhsCoordinateSystemAxis = that.getCoordinateSystemAxis();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "coordinateSystemAxis", lhsCoordinateSystemAxis), LocatorUtils.property(thatLocator, "coordinateSystemAxis", rhsCoordinateSystemAxis), lhsCoordinateSystemAxis, rhsCoordinateSystemAxis)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            CoordinateSystemAxisType theCoordinateSystemAxis;
            theCoordinateSystemAxis = this.getCoordinateSystemAxis();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "coordinateSystemAxis", theCoordinateSystemAxis), currentHashCode, theCoordinateSystemAxis);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CoordinateSystemAxisPropertyType) {
            final CoordinateSystemAxisPropertyType copy = ((CoordinateSystemAxisPropertyType) draftCopy);
            if (this.isSetCoordinateSystemAxis()) {
                CoordinateSystemAxisType sourceCoordinateSystemAxis;
                sourceCoordinateSystemAxis = this.getCoordinateSystemAxis();
                CoordinateSystemAxisType copyCoordinateSystemAxis = ((CoordinateSystemAxisType) strategy.copy(LocatorUtils.property(locator, "coordinateSystemAxis", sourceCoordinateSystemAxis), sourceCoordinateSystemAxis));
                copy.setCoordinateSystemAxis(copyCoordinateSystemAxis);
            } else {
                copy.coordinateSystemAxis = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateSystemAxisPropertyType) {
            final CoordinateSystemAxisPropertyType target = this;
            final CoordinateSystemAxisPropertyType leftObject = ((CoordinateSystemAxisPropertyType) left);
            final CoordinateSystemAxisPropertyType rightObject = ((CoordinateSystemAxisPropertyType) right);
            {
                CoordinateSystemAxisType lhsCoordinateSystemAxis;
                lhsCoordinateSystemAxis = leftObject.getCoordinateSystemAxis();
                CoordinateSystemAxisType rhsCoordinateSystemAxis;
                rhsCoordinateSystemAxis = rightObject.getCoordinateSystemAxis();
                target.setCoordinateSystemAxis(((CoordinateSystemAxisType) strategy.merge(LocatorUtils.property(leftLocator, "coordinateSystemAxis", lhsCoordinateSystemAxis), LocatorUtils.property(rightLocator, "coordinateSystemAxis", rhsCoordinateSystemAxis), lhsCoordinateSystemAxis, rhsCoordinateSystemAxis)));
            }
            {
                List<String> lhsNilReason;
