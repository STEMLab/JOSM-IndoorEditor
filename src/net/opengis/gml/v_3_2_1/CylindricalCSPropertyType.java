 ...
 * 
 * <p>Java-Klasse für CylindricalCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            CylindricalCSType theCylindricalCS;
        ...
        {
            String theTYPE;
            theTYPE = CylindricalCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CylindricalCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CylindricalCSPropertyType that = ((CylindricalCSPropertyType) object);
        {
            CylindricalCSType lhsCylindricalCS;
            lhsCylindricalCS = this.getCylindricalCS();
            CylindricalCSType rhsCylindricalCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CylindricalCSPropertyType) {
            final CylindricalCSPropertyType copy = ((CylindricalCSPropertyType) draftCopy);
            if (this.isSetCylindricalCS()) {
                CylindricalCSType sourceCylindricalCS;
                sourceCylindricalCS = this.getCylindricalCS();
                CylindricalCSType copyCylindricalCS = ((CylindricalCSType) strategy.copy(LocatorUtils.property(locator, "cylindricalCS", sourceCylindricalCS), sourceCylindricalCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CylindricalCSPropertyType) {
            final CylindricalCSPropertyType target = this;
            final CylindricalCSPropertyType leftObject = ((CylindricalCSPropertyType) left);
            final CylindricalCSPropertyType rightObject = ((CylindricalCSPropertyType) right);
            {
                CylindricalCSType lhsCylindricalCS;
                lhsCylindricalCS = leftObject.getCylindricalCS();
                CylindricalCSType rhsCylindricalCS;
                rhsCylindricalCS = rightObject.getCylindricalCS();
                target.setCylindricalCS(((CylindricalCSType) strategy.merge(LocatorUtils.property(leftLocator, "cylindricalCS", lhsCylindricalCS), LocatorUtils.property(rightLocator, "cylindricalCS", rhsCylindricalCS), lhsCylindricalCS, rhsCylindricalCS)));
            }
            {
                List<String> lhsNilReason;
