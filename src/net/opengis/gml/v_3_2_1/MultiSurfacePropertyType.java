 ...
 * 
 * <p>Java-Klasse für MultiSurfacePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = MultiSurfacePropertyType.TYPE;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiSurfacePropertyType) {
            final MultiSurfacePropertyType target = this;
            final MultiSurfacePropertyType leftObject = ((MultiSurfacePropertyType) left);
            final MultiSurfacePropertyType rightObject = ((MultiSurfacePropertyType) right);
            {
                MultiSurfaceType lhsMultiSurface;
                lhsMultiSurface = leftObject.getMultiSurface();
                MultiSurfaceType rhsMultiSurface;
                rhsMultiSurface = rightObject.getMultiSurface();
                target.setMultiSurface(((MultiSurfaceType) strategy.merge(LocatorUtils.property(leftLocator, "multiSurface", lhsMultiSurface), LocatorUtils.property(rightLocator, "multiSurface", rhsMultiSurface), lhsMultiSurface, rhsMultiSurface)));
            }
            {
                boolean lhsOwns;
