 ...
 * 
 * <p>Java-Klasse für OperationParameterGroupPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der operationParameterGroup-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der operationParameterGroup-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link OperationParameterGroupType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationParameterGroupType theOperationParameterGroup;
            theOperationParameterGroup = this.getOperationParameterGroup();
            strategy.appendField(locator, this, "operationParameterGroup", buffer, theOperationParameterGroup);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = OperationParameterGroupPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationParameterGroupPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationParameterGroupPropertyType that = ((OperationParameterGroupPropertyType) object);
        {
            OperationParameterGroupType lhsOperationParameterGroup;
            lhsOperationParameterGroup = this.getOperationParameterGroup();
            OperationParameterGroupType rhsOperationParameterGroup;
            rhsOperationParameterGroup = that.getOperationParameterGroup();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "operationParameterGroup", lhsOperationParameterGroup), LocatorUtils.property(thatLocator, "operationParameterGroup", rhsOperationParameterGroup), lhsOperationParameterGroup, rhsOperationParameterGroup)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            OperationParameterGroupType theOperationParameterGroup;
            theOperationParameterGroup = this.getOperationParameterGroup();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "operationParameterGroup", theOperationParameterGroup), currentHashCode, theOperationParameterGroup);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationParameterGroupPropertyType) {
            final OperationParameterGroupPropertyType copy = ((OperationParameterGroupPropertyType) draftCopy);
            if (this.isSetOperationParameterGroup()) {
                OperationParameterGroupType sourceOperationParameterGroup;
                sourceOperationParameterGroup = this.getOperationParameterGroup();
                OperationParameterGroupType copyOperationParameterGroup = ((OperationParameterGroupType) strategy.copy(LocatorUtils.property(locator, "operationParameterGroup", sourceOperationParameterGroup), sourceOperationParameterGroup));
                copy.setOperationParameterGroup(copyOperationParameterGroup);
            } else {
                copy.operationParameterGroup = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationParameterGroupPropertyType) {
            final OperationParameterGroupPropertyType target = this;
            final OperationParameterGroupPropertyType leftObject = ((OperationParameterGroupPropertyType) left);
            final OperationParameterGroupPropertyType rightObject = ((OperationParameterGroupPropertyType) right);
            {
                OperationParameterGroupType lhsOperationParameterGroup;
                lhsOperationParameterGroup = leftObject.getOperationParameterGroup();
                OperationParameterGroupType rhsOperationParameterGroup;
                rhsOperationParameterGroup = rightObject.getOperationParameterGroup();
                target.setOperationParameterGroup(((OperationParameterGroupType) strategy.merge(LocatorUtils.property(leftLocator, "operationParameterGroup", lhsOperationParameterGroup), LocatorUtils.property(rightLocator, "operationParameterGroup", rhsOperationParameterGroup), lhsOperationParameterGroup, rhsOperationParameterGroup)));
            }
            {
                List<String> lhsNilReason;
