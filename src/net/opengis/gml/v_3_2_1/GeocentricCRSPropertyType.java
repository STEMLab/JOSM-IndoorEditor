...
/**
 * <p>Java-Klasse für GeocentricCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            GeocentricCRSType theGeocentricCRS;
            theGeocentricCRS = this.getGeocentricCRS();
            strategy.appendField(locator, this, "geocentricCRS", buffer, theGeocentricCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = GeocentricCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeocentricCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeocentricCRSPropertyType that = ((GeocentricCRSPropertyType) object);
        {
            GeocentricCRSType lhsGeocentricCRS;
            lhsGeocentricCRS = this.getGeocentricCRS();
            GeocentricCRSType rhsGeocentricCRS;
            rhsGeocentricCRS = that.getGeocentricCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geocentricCRS", lhsGeocentricCRS), LocatorUtils.property(thatLocator, "geocentricCRS", rhsGeocentricCRS), lhsGeocentricCRS, rhsGeocentricCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            GeocentricCRSType theGeocentricCRS;
            theGeocentricCRS = this.getGeocentricCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geocentricCRS", theGeocentricCRS), currentHashCode, theGeocentricCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeocentricCRSPropertyType) {
            final GeocentricCRSPropertyType copy = ((GeocentricCRSPropertyType) draftCopy);
            if (this.isSetGeocentricCRS()) {
                GeocentricCRSType sourceGeocentricCRS;
                sourceGeocentricCRS = this.getGeocentricCRS();
                GeocentricCRSType copyGeocentricCRS = ((GeocentricCRSType) strategy.copy(LocatorUtils.property(locator, "geocentricCRS", sourceGeocentricCRS), sourceGeocentricCRS));
                copy.setGeocentricCRS(copyGeocentricCRS);
            } else {
                copy.geocentricCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeocentricCRSPropertyType) {
            final GeocentricCRSPropertyType target = this;
            final GeocentricCRSPropertyType leftObject = ((GeocentricCRSPropertyType) left);
            final GeocentricCRSPropertyType rightObject = ((GeocentricCRSPropertyType) right);
            {
                GeocentricCRSType lhsGeocentricCRS;
                lhsGeocentricCRS = leftObject.getGeocentricCRS();
                GeocentricCRSType rhsGeocentricCRS;
                rhsGeocentricCRS = rightObject.getGeocentricCRS();
                target.setGeocentricCRS(((GeocentricCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geocentricCRS", lhsGeocentricCRS), LocatorUtils.property(rightLocator, "geocentricCRS", rhsGeocentricCRS), lhsGeocentricCRS, rhsGeocentricCRS)));
            }
            {
                List<String> lhsNilReason;
