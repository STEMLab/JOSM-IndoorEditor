 ...
 * 
 * <p>Java-Klasse für OperationMethodPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationMethodType theOperationMethod;
            theOperationMethod = this.getOperationMethod();
        ...
        {
            String theTYPE;
            theTYPE = OperationMethodPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationMethodPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationMethodPropertyType that = ((OperationMethodPropertyType) object);
        {
            OperationMethodType lhsOperationMethod;
            lhsOperationMethod = this.getOperationMethod();
            OperationMethodType rhsOperationMethod;
            rhsOperationMethod = that.getOperationMethod();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationMethodPropertyType) {
            final OperationMethodPropertyType copy = ((OperationMethodPropertyType) draftCopy);
            if (this.isSetOperationMethod()) {
                OperationMethodType sourceOperationMethod;
                sourceOperationMethod = this.getOperationMethod();
                OperationMethodType copyOperationMethod = ((OperationMethodType) strategy.copy(LocatorUtils.property(locator, "operationMethod", sourceOperationMethod), sourceOperationMethod));
                copy.setOperationMethod(copyOperationMethod);
            } else {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationMethodPropertyType) {
            final OperationMethodPropertyType target = this;
            final OperationMethodPropertyType leftObject = ((OperationMethodPropertyType) left);
            final OperationMethodPropertyType rightObject = ((OperationMethodPropertyType) right);
            {
                OperationMethodType lhsOperationMethod;
                lhsOperationMethod = leftObject.getOperationMethod();
                OperationMethodType rhsOperationMethod;
                rhsOperationMethod = rightObject.getOperationMethod();
                target.setOperationMethod(((OperationMethodType) strategy.merge(LocatorUtils.property(leftLocator, "operationMethod", lhsOperationMethod), LocatorUtils.property(rightLocator, "operationMethod", rhsOperationMethod), lhsOperationMethod, rhsOperationMethod)));
            }
            {
                List<String> lhsNilReason;
