...
/**
 * <p>Java-Klasse für TopoPrimitiveMemberType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractTopoPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractTopoPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractTopoPrimitiveType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractTopoPrimitiveType> theAbstractTopoPrimitive;
        ...
        {
            String theTYPE;
            theTYPE = TopoPrimitiveMemberType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TopoPrimitiveMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TopoPrimitiveMemberType that = ((TopoPrimitiveMemberType) object);
        {
            JAXBElement<? extends AbstractTopoPrimitiveType> lhsAbstractTopoPrimitive;
            lhsAbstractTopoPrimitive = this.getAbstractTopoPrimitive();
            JAXBElement<? extends AbstractTopoPrimitiveType> rhsAbstractTopoPrimitive;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopoPrimitiveMemberType) {
            final TopoPrimitiveMemberType copy = ((TopoPrimitiveMemberType) draftCopy);
            if (this.isSetAbstractTopoPrimitive()) {
                JAXBElement<? extends AbstractTopoPrimitiveType> sourceAbstractTopoPrimitive;
                sourceAbstractTopoPrimitive = this.getAbstractTopoPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractTopoPrimitiveType> copyAbstractTopoPrimitive = ((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractTopoPrimitive", sourceAbstractTopoPrimitive), sourceAbstractTopoPrimitive));
                copy.setAbstractTopoPrimitive(copyAbstractTopoPrimitive);
            } else {
                copy.abstractTopoPrimitive = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopoPrimitiveMemberType) {
            final TopoPrimitiveMemberType target = this;
            final TopoPrimitiveMemberType leftObject = ((TopoPrimitiveMemberType) left);
            final TopoPrimitiveMemberType rightObject = ((TopoPrimitiveMemberType) right);
            {
                JAXBElement<? extends AbstractTopoPrimitiveType> lhsAbstractTopoPrimitive;
                ...
                target.setAbstractTopoPrimitive(((JAXBElement<? extends AbstractTopoPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractTopoPrimitive", lhsAbstractTopoPrimitive), LocatorUtils.property(rightLocator, "abstractTopoPrimitive", rhsAbstractTopoPrimitive), lhsAbstractTopoPrimitive, rhsAbstractTopoPrimitive)));
            }
            {
                boolean lhsOwns;
