    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ReferenceType) {
            final ReferenceType copy = ((ReferenceType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ReferenceType) {
            final ReferenceType target = this;
            final ReferenceType leftObject = ((ReferenceType) left);
            final ReferenceType rightObject = ((ReferenceType) right);
            {
                List<String> lhsNilReason;
