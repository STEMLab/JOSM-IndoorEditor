 ...
 * 
 * <p>Java-Klasse für OperationParameterPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            OperationParameterType theOperationParameter;
        ...
        {
            String theTYPE;
            theTYPE = OperationParameterPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationParameterPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationParameterPropertyType that = ((OperationParameterPropertyType) object);
        {
            OperationParameterType lhsOperationParameter;
            lhsOperationParameter = this.getOperationParameter();
            OperationParameterType rhsOperationParameter;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationParameterPropertyType) {
            final OperationParameterPropertyType copy = ((OperationParameterPropertyType) draftCopy);
            if (this.isSetOperationParameter()) {
                OperationParameterType sourceOperationParameter;
                sourceOperationParameter = this.getOperationParameter();
                OperationParameterType copyOperationParameter = ((OperationParameterType) strategy.copy(LocatorUtils.property(locator, "operationParameter", sourceOperationParameter), sourceOperationParameter));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationParameterPropertyType) {
            final OperationParameterPropertyType target = this;
            final OperationParameterPropertyType leftObject = ((OperationParameterPropertyType) left);
            final OperationParameterPropertyType rightObject = ((OperationParameterPropertyType) right);
            {
                OperationParameterType lhsOperationParameter;
                lhsOperationParameter = leftObject.getOperationParameter();
                OperationParameterType rhsOperationParameter;
                rhsOperationParameter = rightObject.getOperationParameter();
                target.setOperationParameter(((OperationParameterType) strategy.merge(LocatorUtils.property(leftLocator, "operationParameter", lhsOperationParameter), LocatorUtils.property(rightLocator, "operationParameter", rhsOperationParameter), lhsOperationParameter, rhsOperationParameter)));
            }
            {
                List<String> lhsNilReason;
