 ...
 * 
 * <p>Java-Klasse für EllipsoidalCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EllipsoidalCSType theEllipsoidalCS;
        ...
        {
            String theTYPE;
            theTYPE = EllipsoidalCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EllipsoidalCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EllipsoidalCSPropertyType that = ((EllipsoidalCSPropertyType) object);
        {
            EllipsoidalCSType lhsEllipsoidalCS;
            lhsEllipsoidalCS = this.getEllipsoidalCS();
            EllipsoidalCSType rhsEllipsoidalCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EllipsoidalCSPropertyType) {
            final EllipsoidalCSPropertyType copy = ((EllipsoidalCSPropertyType) draftCopy);
            if (this.isSetEllipsoidalCS()) {
                EllipsoidalCSType sourceEllipsoidalCS;
                sourceEllipsoidalCS = this.getEllipsoidalCS();
                EllipsoidalCSType copyEllipsoidalCS = ((EllipsoidalCSType) strategy.copy(LocatorUtils.property(locator, "ellipsoidalCS", sourceEllipsoidalCS), sourceEllipsoidalCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof EllipsoidalCSPropertyType) {
            final EllipsoidalCSPropertyType target = this;
            final EllipsoidalCSPropertyType leftObject = ((EllipsoidalCSPropertyType) left);
            final EllipsoidalCSPropertyType rightObject = ((EllipsoidalCSPropertyType) right);
            {
                EllipsoidalCSType lhsEllipsoidalCS;
                lhsEllipsoidalCS = leftObject.getEllipsoidalCS();
                EllipsoidalCSType rhsEllipsoidalCS;
                rhsEllipsoidalCS = rightObject.getEllipsoidalCS();
                target.setEllipsoidalCS(((EllipsoidalCSType) strategy.merge(LocatorUtils.property(leftLocator, "ellipsoidalCS", lhsEllipsoidalCS), LocatorUtils.property(rightLocator, "ellipsoidalCS", rhsEllipsoidalCS), lhsEllipsoidalCS, rhsEllipsoidalCS)));
            }
            {
                List<String> lhsNilReason;
