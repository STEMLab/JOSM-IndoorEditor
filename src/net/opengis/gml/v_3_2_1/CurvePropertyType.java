    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCurveType> theAbstractCurve;
        ...
        {
            String theTYPE;
            theTYPE = CurvePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractCurveType> lhsAbstractCurve;
            lhsAbstractCurve = this.getAbstractCurve();
            JAXBElement<? extends AbstractCurveType> rhsAbstractCurve;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CurvePropertyType) {
            final CurvePropertyType copy = ((CurvePropertyType) draftCopy);
            if (this.isSetAbstractCurve()) {
                JAXBElement<? extends AbstractCurveType> sourceAbstractCurve;
                sourceAbstractCurve = this.getAbstractCurve();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCurveType> copyAbstractCurve = ((JAXBElement<? extends AbstractCurveType> ) strategy.copy(LocatorUtils.property(locator, "abstractCurve", sourceAbstractCurve), sourceAbstractCurve));
                copy.setAbstractCurve(copyAbstractCurve);
            } else {
                copy.abstractCurve = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CurvePropertyType) {
            final CurvePropertyType target = this;
            final CurvePropertyType leftObject = ((CurvePropertyType) left);
            final CurvePropertyType rightObject = ((CurvePropertyType) right);
            {
                JAXBElement<? extends AbstractCurveType> lhsAbstractCurve;
                lhsAbstractCurve = leftObject.getAbstractCurve();
                JAXBElement<? extends AbstractCurveType> rhsAbstractCurve;
                rhsAbstractCurve = rightObject.getAbstractCurve();
                target.setAbstractCurve(((JAXBElement<? extends AbstractCurveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCurve", lhsAbstractCurve), LocatorUtils.property(rightLocator, "abstractCurve", rhsAbstractCurve), lhsAbstractCurve, rhsAbstractCurve)));
            }
            {
                boolean lhsOwns;
