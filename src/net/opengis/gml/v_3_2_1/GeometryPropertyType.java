 ...
 * 
 * <p>Java-Klasse für GeometryPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = GeometryPropertyType.TYPE;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeometryPropertyType) {
            final GeometryPropertyType copy = ((GeometryPropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeometryPropertyType) {
            final GeometryPropertyType target = this;
            final GeometryPropertyType leftObject = ((GeometryPropertyType) left);
            final GeometryPropertyType rightObject = ((GeometryPropertyType) right);
            {
                JAXBElement<? extends AbstractGeometryType> lhsAbstractGeometry;
