 ...
 * 
 * <p>Java-Klasse für ProjectedCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der projectedCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der projectedCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ProjectedCRSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ProjectedCRSType theProjectedCRS;
            theProjectedCRS = this.getProjectedCRS();
            strategy.appendField(locator, this, "projectedCRS", buffer, theProjectedCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ProjectedCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ProjectedCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ProjectedCRSPropertyType that = ((ProjectedCRSPropertyType) object);
        {
            ProjectedCRSType lhsProjectedCRS;
            lhsProjectedCRS = this.getProjectedCRS();
            ProjectedCRSType rhsProjectedCRS;
            rhsProjectedCRS = that.getProjectedCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "projectedCRS", lhsProjectedCRS), LocatorUtils.property(thatLocator, "projectedCRS", rhsProjectedCRS), lhsProjectedCRS, rhsProjectedCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ProjectedCRSType theProjectedCRS;
            theProjectedCRS = this.getProjectedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "projectedCRS", theProjectedCRS), currentHashCode, theProjectedCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ProjectedCRSPropertyType) {
            final ProjectedCRSPropertyType copy = ((ProjectedCRSPropertyType) draftCopy);
            if (this.isSetProjectedCRS()) {
                ProjectedCRSType sourceProjectedCRS;
                sourceProjectedCRS = this.getProjectedCRS();
                ProjectedCRSType copyProjectedCRS = ((ProjectedCRSType) strategy.copy(LocatorUtils.property(locator, "projectedCRS", sourceProjectedCRS), sourceProjectedCRS));
                copy.setProjectedCRS(copyProjectedCRS);
            } else {
                copy.projectedCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ProjectedCRSPropertyType) {
            final ProjectedCRSPropertyType target = this;
            final ProjectedCRSPropertyType leftObject = ((ProjectedCRSPropertyType) left);
            final ProjectedCRSPropertyType rightObject = ((ProjectedCRSPropertyType) right);
            {
                ProjectedCRSType lhsProjectedCRS;
                lhsProjectedCRS = leftObject.getProjectedCRS();
                ProjectedCRSType rhsProjectedCRS;
                rhsProjectedCRS = rightObject.getProjectedCRS();
                target.setProjectedCRS(((ProjectedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "projectedCRS", lhsProjectedCRS), LocatorUtils.property(rightLocator, "projectedCRS", rhsProjectedCRS), lhsProjectedCRS, rhsProjectedCRS)));
            }
            {
                List<String> lhsNilReason;
