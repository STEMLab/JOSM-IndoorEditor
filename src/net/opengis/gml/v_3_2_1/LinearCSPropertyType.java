 ...
 * 
 * <p>Java-Klasse für LinearCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = LinearCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinearCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinearCSPropertyType that = ((LinearCSPropertyType) object);
        {
            LinearCSType lhsLinearCS;
            lhsLinearCS = this.getLinearCS();
            LinearCSType rhsLinearCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LinearCSPropertyType) {
            final LinearCSPropertyType copy = ((LinearCSPropertyType) draftCopy);
            if (this.isSetLinearCS()) {
                LinearCSType sourceLinearCS;
                sourceLinearCS = this.getLinearCS();
                LinearCSType copyLinearCS = ((LinearCSType) strategy.copy(LocatorUtils.property(locator, "linearCS", sourceLinearCS), sourceLinearCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof LinearCSPropertyType) {
            final LinearCSPropertyType target = this;
            final LinearCSPropertyType leftObject = ((LinearCSPropertyType) left);
            final LinearCSPropertyType rightObject = ((LinearCSPropertyType) right);
            {
                LinearCSType lhsLinearCS;
                lhsLinearCS = leftObject.getLinearCS();
                LinearCSType rhsLinearCS;
                rhsLinearCS = rightObject.getLinearCS();
                target.setLinearCS(((LinearCSType) strategy.merge(LocatorUtils.property(leftLocator, "linearCS", lhsLinearCS), LocatorUtils.property(rightLocator, "linearCS", rhsLinearCS), lhsLinearCS, rhsLinearCS)));
            }
            {
                List<String> lhsNilReason;
