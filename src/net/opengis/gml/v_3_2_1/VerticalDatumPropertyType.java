 ...
 * 
 * <p>Java-Klasse für VerticalDatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = VerticalDatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalDatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalDatumPropertyType that = ((VerticalDatumPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalDatumPropertyType) {
            final VerticalDatumPropertyType copy = ((VerticalDatumPropertyType) draftCopy);
            if (this.isSetVerticalDatum()) {
                VerticalDatumType sourceVerticalDatum;
                sourceVerticalDatum = this.getVerticalDatum();
                VerticalDatumType copyVerticalDatum = ((VerticalDatumType) strategy.copy(LocatorUtils.property(locator, "verticalDatum", sourceVerticalDatum), sourceVerticalDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalDatumPropertyType) {
            final VerticalDatumPropertyType target = this;
            final VerticalDatumPropertyType leftObject = ((VerticalDatumPropertyType) left);
            final VerticalDatumPropertyType rightObject = ((VerticalDatumPropertyType) right);
            {
                VerticalDatumType lhsVerticalDatum;
                lhsVerticalDatum = leftObject.getVerticalDatum();
                VerticalDatumType rhsVerticalDatum;
                rhsVerticalDatum = rightObject.getVerticalDatum();
                target.setVerticalDatum(((VerticalDatumType) strategy.merge(LocatorUtils.property(leftLocator, "verticalDatum", lhsVerticalDatum), LocatorUtils.property(rightLocator, "verticalDatum", rhsVerticalDatum), lhsVerticalDatum, rhsVerticalDatum)));
            }
            {
                List<String> lhsNilReason;
