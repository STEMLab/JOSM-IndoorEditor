 ...
 * 
 * <p>Java-Klasse für EngineeringDatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            EngineeringDatumType theEngineeringDatum;
        ...
        {
            String theTYPE;
            theTYPE = EngineeringDatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EngineeringDatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            EngineeringDatumType lhsEngineeringDatum;
            lhsEngineeringDatum = this.getEngineeringDatum();
            EngineeringDatumType rhsEngineeringDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof EngineeringDatumPropertyType) {
            final EngineeringDatumPropertyType copy = ((EngineeringDatumPropertyType) draftCopy);
            if (this.isSetEngineeringDatum()) {
                EngineeringDatumType sourceEngineeringDatum;
                sourceEngineeringDatum = this.getEngineeringDatum();
                EngineeringDatumType copyEngineeringDatum = ((EngineeringDatumType) strategy.copy(LocatorUtils.property(locator, "engineeringDatum", sourceEngineeringDatum), sourceEngineeringDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof EngineeringDatumPropertyType) {
            final EngineeringDatumPropertyType target = this;
            final EngineeringDatumPropertyType leftObject = ((EngineeringDatumPropertyType) left);
            final EngineeringDatumPropertyType rightObject = ((EngineeringDatumPropertyType) right);
            {
                EngineeringDatumType lhsEngineeringDatum;
                lhsEngineeringDatum = leftObject.getEngineeringDatum();
                EngineeringDatumType rhsEngineeringDatum;
                rhsEngineeringDatum = rightObject.getEngineeringDatum();
                target.setEngineeringDatum(((EngineeringDatumType) strategy.merge(LocatorUtils.property(leftLocator, "engineeringDatum", lhsEngineeringDatum), LocatorUtils.property(rightLocator, "engineeringDatum", rhsEngineeringDatum), lhsEngineeringDatum, rhsEngineeringDatum)));
            }
            {
                List<String> lhsNilReason;
