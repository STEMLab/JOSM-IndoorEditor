 ...
 * 
 * <p>Java-Klasse für SphericalCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SphericalCSType theSphericalCS;
        ...
        {
            String theTYPE;
            theTYPE = SphericalCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SphericalCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            SphericalCSType lhsSphericalCS;
            lhsSphericalCS = this.getSphericalCS();
            SphericalCSType rhsSphericalCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SphericalCSPropertyType) {
            final SphericalCSPropertyType copy = ((SphericalCSPropertyType) draftCopy);
            if (this.isSetSphericalCS()) {
                SphericalCSType sourceSphericalCS;
                sourceSphericalCS = this.getSphericalCS();
                SphericalCSType copySphericalCS = ((SphericalCSType) strategy.copy(LocatorUtils.property(locator, "sphericalCS", sourceSphericalCS), sourceSphericalCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SphericalCSPropertyType) {
            final SphericalCSPropertyType target = this;
            final SphericalCSPropertyType leftObject = ((SphericalCSPropertyType) left);
            final SphericalCSPropertyType rightObject = ((SphericalCSPropertyType) right);
            {
                SphericalCSType lhsSphericalCS;
                lhsSphericalCS = leftObject.getSphericalCS();
                SphericalCSType rhsSphericalCS;
                rhsSphericalCS = rightObject.getSphericalCS();
                target.setSphericalCS(((SphericalCSType) strategy.merge(LocatorUtils.property(leftLocator, "sphericalCS", lhsSphericalCS), LocatorUtils.property(rightLocator, "sphericalCS", rhsSphericalCS), lhsSphericalCS, rhsSphericalCS)));
            }
            {
                List<String> lhsNilReason;
