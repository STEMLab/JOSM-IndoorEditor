 ...
 * 
 * <p>Java-Klasse für SingleCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractSingleCRS", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractSingleCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractSingleCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ImageCRSType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCRSType> theAbstractSingleCRS;
            theAbstractSingleCRS = this.getAbstractSingleCRS();
            strategy.appendField(locator, this, "abstractSingleCRS", buffer, theAbstractSingleCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = SingleCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SingleCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            JAXBElement<? extends AbstractCRSType> lhsAbstractSingleCRS;
            lhsAbstractSingleCRS = this.getAbstractSingleCRS();
            JAXBElement<? extends AbstractCRSType> rhsAbstractSingleCRS;
            rhsAbstractSingleCRS = that.getAbstractSingleCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractSingleCRS", lhsAbstractSingleCRS), LocatorUtils.property(thatLocator, "abstractSingleCRS", rhsAbstractSingleCRS), lhsAbstractSingleCRS, rhsAbstractSingleCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCRSType> theAbstractSingleCRS;
            theAbstractSingleCRS = this.getAbstractSingleCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractSingleCRS", theAbstractSingleCRS), currentHashCode, theAbstractSingleCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SingleCRSPropertyType) {
            final SingleCRSPropertyType copy = ((SingleCRSPropertyType) draftCopy);
            if (this.isSetAbstractSingleCRS()) {
                JAXBElement<? extends AbstractCRSType> sourceAbstractSingleCRS;
                sourceAbstractSingleCRS = this.getAbstractSingleCRS();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCRSType> copyAbstractSingleCRS = ((JAXBElement<? extends AbstractCRSType> ) strategy.copy(LocatorUtils.property(locator, "abstractSingleCRS", sourceAbstractSingleCRS), sourceAbstractSingleCRS));
                copy.setAbstractSingleCRS(copyAbstractSingleCRS);
            } else {
                copy.abstractSingleCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SingleCRSPropertyType) {
            final SingleCRSPropertyType target = this;
            final SingleCRSPropertyType leftObject = ((SingleCRSPropertyType) left);
            final SingleCRSPropertyType rightObject = ((SingleCRSPropertyType) right);
            {
                JAXBElement<? extends AbstractCRSType> lhsAbstractSingleCRS;
                lhsAbstractSingleCRS = leftObject.getAbstractSingleCRS();
                JAXBElement<? extends AbstractCRSType> rhsAbstractSingleCRS;
                rhsAbstractSingleCRS = rightObject.getAbstractSingleCRS();
                target.setAbstractSingleCRS(((JAXBElement<? extends AbstractCRSType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractSingleCRS", lhsAbstractSingleCRS), LocatorUtils.property(rightLocator, "abstractSingleCRS", rhsAbstractSingleCRS), lhsAbstractSingleCRS, rhsAbstractSingleCRS)));
            }
            {
                List<String> lhsNilReason;
