 ...
 * 
 * <p>Java-Klasse für UserDefinedCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            UserDefinedCSType theUserDefinedCS;
        ...
        {
            String theTYPE;
            theTYPE = UserDefinedCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UserDefinedCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UserDefinedCSPropertyType that = ((UserDefinedCSPropertyType) object);
        {
            UserDefinedCSType lhsUserDefinedCS;
            lhsUserDefinedCS = this.getUserDefinedCS();
            UserDefinedCSType rhsUserDefinedCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof UserDefinedCSPropertyType) {
            final UserDefinedCSPropertyType copy = ((UserDefinedCSPropertyType) draftCopy);
            if (this.isSetUserDefinedCS()) {
                UserDefinedCSType sourceUserDefinedCS;
                sourceUserDefinedCS = this.getUserDefinedCS();
                UserDefinedCSType copyUserDefinedCS = ((UserDefinedCSType) strategy.copy(LocatorUtils.property(locator, "userDefinedCS", sourceUserDefinedCS), sourceUserDefinedCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof UserDefinedCSPropertyType) {
            final UserDefinedCSPropertyType target = this;
            final UserDefinedCSPropertyType leftObject = ((UserDefinedCSPropertyType) left);
            final UserDefinedCSPropertyType rightObject = ((UserDefinedCSPropertyType) right);
            {
                UserDefinedCSType lhsUserDefinedCS;
                lhsUserDefinedCS = leftObject.getUserDefinedCS();
                UserDefinedCSType rhsUserDefinedCS;
                rhsUserDefinedCS = rightObject.getUserDefinedCS();
                target.setUserDefinedCS(((UserDefinedCSType) strategy.merge(LocatorUtils.property(leftLocator, "userDefinedCS", lhsUserDefinedCS), LocatorUtils.property(rightLocator, "userDefinedCS", rhsUserDefinedCS), lhsUserDefinedCS, rhsUserDefinedCS)));
            }
            {
                List<String> lhsNilReason;
