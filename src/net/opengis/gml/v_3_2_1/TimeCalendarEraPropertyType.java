 ...
 * 
 * <p>Java-Klasse für TimeCalendarEraPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeCalendarEra-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der timeCalendarEra-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeCalendarEraType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeCalendarEraType theTimeCalendarEra;
            theTimeCalendarEra = this.getTimeCalendarEra();
            strategy.appendField(locator, this, "timeCalendarEra", buffer, theTimeCalendarEra);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TimeCalendarEraPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final TimeCalendarEraPropertyType that = ((TimeCalendarEraPropertyType) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeCalendarEra", lhsTimeCalendarEra), LocatorUtils.property(thatLocator, "timeCalendarEra", rhsTimeCalendarEra), lhsTimeCalendarEra, rhsTimeCalendarEra)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeCalendarEraType theTimeCalendarEra;
            theTimeCalendarEra = this.getTimeCalendarEra();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeCalendarEra", theTimeCalendarEra), currentHashCode, theTimeCalendarEra);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeCalendarEraPropertyType) {
            ...
            if (this.isSetTimeCalendarEra()) {
                ...
                TimeCalendarEraType copyTimeCalendarEra = ((TimeCalendarEraType) strategy.copy(LocatorUtils.property(locator, "timeCalendarEra", sourceTimeCalendarEra), sourceTimeCalendarEra));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeCalendarEraPropertyType) {
            ...
            final TimeCalendarEraPropertyType rightObject = ((TimeCalendarEraPropertyType) right);
            {
                ...
                target.setTimeCalendarEra(((TimeCalendarEraType) strategy.merge(LocatorUtils.property(leftLocator, "timeCalendarEra", lhsTimeCalendarEra), LocatorUtils.property(rightLocator, "timeCalendarEra", rhsTimeCalendarEra), lhsTimeCalendarEra, rhsTimeCalendarEra)));
            }
            {
                List<String> lhsNilReason;
