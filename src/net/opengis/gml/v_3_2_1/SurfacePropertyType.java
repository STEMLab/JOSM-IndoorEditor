    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractSurfaceType> theAbstractSurface;
        ...
        {
            String theTYPE;
            theTYPE = SurfacePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            JAXBElement<? extends AbstractSurfaceType> lhsAbstractSurface;
            lhsAbstractSurface = this.getAbstractSurface();
            JAXBElement<? extends AbstractSurfaceType> rhsAbstractSurface;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SurfacePropertyType) {
            final SurfacePropertyType copy = ((SurfacePropertyType) draftCopy);
            if (this.isSetAbstractSurface()) {
                JAXBElement<? extends AbstractSurfaceType> sourceAbstractSurface;
                sourceAbstractSurface = this.getAbstractSurface();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractSurfaceType> copyAbstractSurface = ((JAXBElement<? extends AbstractSurfaceType> ) strategy.copy(LocatorUtils.property(locator, "abstractSurface", sourceAbstractSurface), sourceAbstractSurface));
                copy.setAbstractSurface(copyAbstractSurface);
            } else {
                copy.abstractSurface = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof SurfacePropertyType) {
            final SurfacePropertyType target = this;
            final SurfacePropertyType leftObject = ((SurfacePropertyType) left);
            final SurfacePropertyType rightObject = ((SurfacePropertyType) right);
            {
                JAXBElement<? extends AbstractSurfaceType> lhsAbstractSurface;
                lhsAbstractSurface = leftObject.getAbstractSurface();
                JAXBElement<? extends AbstractSurfaceType> rhsAbstractSurface;
                rhsAbstractSurface = rightObject.getAbstractSurface();
                target.setAbstractSurface(((JAXBElement<? extends AbstractSurfaceType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractSurface", lhsAbstractSurface), LocatorUtils.property(rightLocator, "abstractSurface", rhsAbstractSurface), lhsAbstractSurface, rhsAbstractSurface)));
            }
            {
                List<String> lhsNilReason;
