 ...
 * 
 * <p>Java-Klasse für MultiSolidPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der multiSolid-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link MultiSolidType }
    ...
    /**
     * Legt den Wert der multiSolid-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link MultiSolidType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            MultiSolidType theMultiSolid;
            theMultiSolid = this.getMultiSolid();
            strategy.appendField(locator, this, "multiSolid", buffer, theMultiSolid);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = MultiSolidPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MultiSolidPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MultiSolidPropertyType that = ((MultiSolidPropertyType) object);
        {
            MultiSolidType lhsMultiSolid;
            lhsMultiSolid = this.getMultiSolid();
            MultiSolidType rhsMultiSolid;
            rhsMultiSolid = that.getMultiSolid();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "multiSolid", lhsMultiSolid), LocatorUtils.property(thatLocator, "multiSolid", rhsMultiSolid), lhsMultiSolid, rhsMultiSolid)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            MultiSolidType theMultiSolid;
            theMultiSolid = this.getMultiSolid();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "multiSolid", theMultiSolid), currentHashCode, theMultiSolid);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof MultiSolidPropertyType) {
            final MultiSolidPropertyType copy = ((MultiSolidPropertyType) draftCopy);
            if (this.isSetMultiSolid()) {
                MultiSolidType sourceMultiSolid;
                sourceMultiSolid = this.getMultiSolid();
                MultiSolidType copyMultiSolid = ((MultiSolidType) strategy.copy(LocatorUtils.property(locator, "multiSolid", sourceMultiSolid), sourceMultiSolid));
                copy.setMultiSolid(copyMultiSolid);
            } else {
                copy.multiSolid = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiSolidPropertyType) {
            final MultiSolidPropertyType target = this;
            final MultiSolidPropertyType leftObject = ((MultiSolidPropertyType) left);
            final MultiSolidPropertyType rightObject = ((MultiSolidPropertyType) right);
            {
                MultiSolidType lhsMultiSolid;
                lhsMultiSolid = leftObject.getMultiSolid();
                MultiSolidType rhsMultiSolid;
                rhsMultiSolid = rightObject.getMultiSolid();
                target.setMultiSolid(((MultiSolidType) strategy.merge(LocatorUtils.property(leftLocator, "multiSolid", lhsMultiSolid), LocatorUtils.property(rightLocator, "multiSolid", rhsMultiSolid), lhsMultiSolid, rhsMultiSolid)));
            }
            {
                List<String> lhsNilReason;
