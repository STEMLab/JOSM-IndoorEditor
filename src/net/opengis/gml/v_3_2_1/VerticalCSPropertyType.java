 ...
 * 
 * <p>Java-Klasse für VerticalCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = VerticalCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof VerticalCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final VerticalCSPropertyType that = ((VerticalCSPropertyType) object);
        {
            VerticalCSType lhsVerticalCS;
            lhsVerticalCS = this.getVerticalCS();
            VerticalCSType rhsVerticalCS;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VerticalCSPropertyType) {
            final VerticalCSPropertyType copy = ((VerticalCSPropertyType) draftCopy);
            if (this.isSetVerticalCS()) {
                VerticalCSType sourceVerticalCS;
                sourceVerticalCS = this.getVerticalCS();
                VerticalCSType copyVerticalCS = ((VerticalCSType) strategy.copy(LocatorUtils.property(locator, "verticalCS", sourceVerticalCS), sourceVerticalCS));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof VerticalCSPropertyType) {
            final VerticalCSPropertyType target = this;
            final VerticalCSPropertyType leftObject = ((VerticalCSPropertyType) left);
            final VerticalCSPropertyType rightObject = ((VerticalCSPropertyType) right);
            {
                VerticalCSType lhsVerticalCS;
                lhsVerticalCS = leftObject.getVerticalCS();
                VerticalCSType rhsVerticalCS;
                rhsVerticalCS = rightObject.getVerticalCS();
                target.setVerticalCS(((VerticalCSType) strategy.merge(LocatorUtils.property(leftLocator, "verticalCS", lhsVerticalCS), LocatorUtils.property(rightLocator, "verticalCS", rhsVerticalCS), lhsVerticalCS, rhsVerticalCS)));
            }
            {
                List<String> lhsNilReason;
