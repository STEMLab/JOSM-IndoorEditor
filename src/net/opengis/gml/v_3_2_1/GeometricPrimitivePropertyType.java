 ...
 * 
 * <p>Java-Klasse für GeometricPrimitivePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractGeometricPrimitive-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractGeometricPrimitive-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link OrientableSurfaceType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> theAbstractGeometricPrimitive;
            theAbstractGeometricPrimitive = this.getAbstractGeometricPrimitive();
            strategy.appendField(locator, this, "abstractGeometricPrimitive", buffer, theAbstractGeometricPrimitive);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = GeometricPrimitivePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeometricPrimitivePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeometricPrimitivePropertyType that = ((GeometricPrimitivePropertyType) object);
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> lhsAbstractGeometricPrimitive;
            lhsAbstractGeometricPrimitive = this.getAbstractGeometricPrimitive();
            JAXBElement<? extends AbstractGeometricPrimitiveType> rhsAbstractGeometricPrimitive;
            rhsAbstractGeometricPrimitive = that.getAbstractGeometricPrimitive();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractGeometricPrimitive", lhsAbstractGeometricPrimitive), LocatorUtils.property(thatLocator, "abstractGeometricPrimitive", rhsAbstractGeometricPrimitive), lhsAbstractGeometricPrimitive, rhsAbstractGeometricPrimitive)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeometricPrimitiveType> theAbstractGeometricPrimitive;
            theAbstractGeometricPrimitive = this.getAbstractGeometricPrimitive();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractGeometricPrimitive", theAbstractGeometricPrimitive), currentHashCode, theAbstractGeometricPrimitive);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeometricPrimitivePropertyType) {
            final GeometricPrimitivePropertyType copy = ((GeometricPrimitivePropertyType) draftCopy);
            if (this.isSetAbstractGeometricPrimitive()) {
                JAXBElement<? extends AbstractGeometricPrimitiveType> sourceAbstractGeometricPrimitive;
                sourceAbstractGeometricPrimitive = this.getAbstractGeometricPrimitive();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeometricPrimitiveType> copyAbstractGeometricPrimitive = ((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.copy(LocatorUtils.property(locator, "abstractGeometricPrimitive", sourceAbstractGeometricPrimitive), sourceAbstractGeometricPrimitive));
                copy.setAbstractGeometricPrimitive(copyAbstractGeometricPrimitive);
            } else {
                copy.abstractGeometricPrimitive = null;
            }
            if (this.isSetOwns()) {
                boolean sourceOwns;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeometricPrimitivePropertyType) {
            final GeometricPrimitivePropertyType target = this;
            final GeometricPrimitivePropertyType leftObject = ((GeometricPrimitivePropertyType) left);
            final GeometricPrimitivePropertyType rightObject = ((GeometricPrimitivePropertyType) right);
            {
                JAXBElement<? extends AbstractGeometricPrimitiveType> lhsAbstractGeometricPrimitive;
                lhsAbstractGeometricPrimitive = leftObject.getAbstractGeometricPrimitive();
                JAXBElement<? extends AbstractGeometricPrimitiveType> rhsAbstractGeometricPrimitive;
                rhsAbstractGeometricPrimitive = rightObject.getAbstractGeometricPrimitive();
                target.setAbstractGeometricPrimitive(((JAXBElement<? extends AbstractGeometricPrimitiveType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractGeometricPrimitive", lhsAbstractGeometricPrimitive), LocatorUtils.property(rightLocator, "abstractGeometricPrimitive", rhsAbstractGeometricPrimitive), lhsAbstractGeometricPrimitive, rhsAbstractGeometricPrimitive)));
            }
            {
                boolean lhsOwns;
