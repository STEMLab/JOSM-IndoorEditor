...
/**
 * <p>Java-Klasse für CategoryPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = CategoryPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CategoryPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CategoryPropertyType) {
            final CategoryPropertyType copy = ((CategoryPropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CategoryPropertyType) {
            final CategoryPropertyType target = this;
            final CategoryPropertyType leftObject = ((CategoryPropertyType) left);
            final CategoryPropertyType rightObject = ((CategoryPropertyType) right);
            {
                Category lhsCategory;
                lhsCategory = leftObject.getCategory();
                Category rhsCategory;
                rhsCategory = rightObject.getCategory();
                target.setCategory(((Category) strategy.merge(LocatorUtils.property(leftLocator, "category", lhsCategory), LocatorUtils.property(rightLocator, "category", rhsCategory), lhsCategory, rhsCategory)));
            }
            {
                List<String> lhsNilReason;
