 ...
 * 
 * <p>Java-Klasse für TimeEdgePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeEdge-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link TimeEdgeType }
    ...
    /**
     * Legt den Wert der timeEdge-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeEdgeType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeEdgeType theTimeEdge;
            theTimeEdge = this.getTimeEdge();
            strategy.appendField(locator, this, "timeEdge", buffer, theTimeEdge);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TimeEdgePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeEdgePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeEdgePropertyType that = ((TimeEdgePropertyType) object);
        {
            TimeEdgeType lhsTimeEdge;
            lhsTimeEdge = this.getTimeEdge();
            TimeEdgeType rhsTimeEdge;
            rhsTimeEdge = that.getTimeEdge();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeEdge", lhsTimeEdge), LocatorUtils.property(thatLocator, "timeEdge", rhsTimeEdge), lhsTimeEdge, rhsTimeEdge)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeEdgeType theTimeEdge;
            theTimeEdge = this.getTimeEdge();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeEdge", theTimeEdge), currentHashCode, theTimeEdge);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeEdgePropertyType) {
            final TimeEdgePropertyType copy = ((TimeEdgePropertyType) draftCopy);
            if (this.isSetTimeEdge()) {
                TimeEdgeType sourceTimeEdge;
                sourceTimeEdge = this.getTimeEdge();
                TimeEdgeType copyTimeEdge = ((TimeEdgeType) strategy.copy(LocatorUtils.property(locator, "timeEdge", sourceTimeEdge), sourceTimeEdge));
                copy.setTimeEdge(copyTimeEdge);
            } else {
                copy.timeEdge = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeEdgePropertyType) {
            final TimeEdgePropertyType target = this;
            final TimeEdgePropertyType leftObject = ((TimeEdgePropertyType) left);
            final TimeEdgePropertyType rightObject = ((TimeEdgePropertyType) right);
            {
                TimeEdgeType lhsTimeEdge;
                lhsTimeEdge = leftObject.getTimeEdge();
                TimeEdgeType rhsTimeEdge;
                rhsTimeEdge = rightObject.getTimeEdge();
                target.setTimeEdge(((TimeEdgeType) strategy.merge(LocatorUtils.property(leftLocator, "timeEdge", lhsTimeEdge), LocatorUtils.property(rightLocator, "timeEdge", rhsTimeEdge), lhsTimeEdge, rhsTimeEdge)));
            }
            {
                List<String> lhsNilReason;
