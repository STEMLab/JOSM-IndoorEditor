...
/**
 * <p>Java-Klasse für StringOrRefType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof StringOrRefType) {
            final StringOrRefType copy = ((StringOrRefType) draftCopy);
            if (this.isSetValue()) {
                String sourceValue;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof StringOrRefType) {
            final StringOrRefType target = this;
            final StringOrRefType leftObject = ((StringOrRefType) left);
            final StringOrRefType rightObject = ((StringOrRefType) right);
            {
                String lhsValue;
