...
/**
 * <p>Java-Klasse für NodeOrEdgePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = NodeOrEdgePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NodeOrEdgePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof NodeOrEdgePropertyType) {
            final NodeOrEdgePropertyType copy = ((NodeOrEdgePropertyType) draftCopy);
            if (this.isSetNode()) {
                NodeType sourceNode;
                sourceNode = this.getNode();
                NodeType copyNode = ((NodeType) strategy.copy(LocatorUtils.property(locator, "node", sourceNode), sourceNode));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof NodeOrEdgePropertyType) {
            final NodeOrEdgePropertyType target = this;
            final NodeOrEdgePropertyType leftObject = ((NodeOrEdgePropertyType) left);
            final NodeOrEdgePropertyType rightObject = ((NodeOrEdgePropertyType) right);
            {
                NodeType lhsNode;
                lhsNode = leftObject.getNode();
                NodeType rhsNode;
                rhsNode = rightObject.getNode();
                target.setNode(((NodeType) strategy.merge(LocatorUtils.property(leftLocator, "node", lhsNode), LocatorUtils.property(rightLocator, "node", rhsNode), lhsNode, rhsNode)));
            }
            {
                EdgeType lhsEdge;
                lhsEdge = leftObject.getEdge();
                EdgeType rhsEdge;
                rhsEdge = rightObject.getEdge();
                target.setEdge(((EdgeType) strategy.merge(LocatorUtils.property(leftLocator, "edge", lhsEdge), LocatorUtils.property(rightLocator, "edge", rhsEdge), lhsEdge, rhsEdge)));
            }
            {
                boolean lhsOwns;
