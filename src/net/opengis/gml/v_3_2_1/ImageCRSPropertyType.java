 ...
 * 
 * <p>Java-Klasse für ImageCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ImageCRSType theImageCRS;
            theImageCRS = this.getImageCRS();
            strategy.appendField(locator, this, "imageCRS", buffer, theImageCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = ImageCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImageCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImageCRSPropertyType that = ((ImageCRSPropertyType) object);
        {
            ImageCRSType lhsImageCRS;
            lhsImageCRS = this.getImageCRS();
            ImageCRSType rhsImageCRS;
            rhsImageCRS = that.getImageCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "imageCRS", lhsImageCRS), LocatorUtils.property(thatLocator, "imageCRS", rhsImageCRS), lhsImageCRS, rhsImageCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            ImageCRSType theImageCRS;
            theImageCRS = this.getImageCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "imageCRS", theImageCRS), currentHashCode, theImageCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ImageCRSPropertyType) {
            final ImageCRSPropertyType copy = ((ImageCRSPropertyType) draftCopy);
            if (this.isSetImageCRS()) {
                ImageCRSType sourceImageCRS;
                sourceImageCRS = this.getImageCRS();
                ImageCRSType copyImageCRS = ((ImageCRSType) strategy.copy(LocatorUtils.property(locator, "imageCRS", sourceImageCRS), sourceImageCRS));
                copy.setImageCRS(copyImageCRS);
            } else {
                copy.imageCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ImageCRSPropertyType) {
            final ImageCRSPropertyType target = this;
            final ImageCRSPropertyType leftObject = ((ImageCRSPropertyType) left);
            final ImageCRSPropertyType rightObject = ((ImageCRSPropertyType) right);
            {
                ImageCRSType lhsImageCRS;
                lhsImageCRS = leftObject.getImageCRS();
                ImageCRSType rhsImageCRS;
                rhsImageCRS = rightObject.getImageCRS();
                target.setImageCRS(((ImageCRSType) strategy.merge(LocatorUtils.property(leftLocator, "imageCRS", lhsImageCRS), LocatorUtils.property(rightLocator, "imageCRS", rhsImageCRS), lhsImageCRS, rhsImageCRS)));
            }
            {
                List<String> lhsNilReason;
