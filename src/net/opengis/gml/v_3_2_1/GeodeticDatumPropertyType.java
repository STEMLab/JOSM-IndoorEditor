 ...
 * 
 * <p>Java-Klasse für GeodeticDatumPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            GeodeticDatumType theGeodeticDatum;
        ...
        {
            String theTYPE;
            theTYPE = GeodeticDatumPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeodeticDatumPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeodeticDatumPropertyType that = ((GeodeticDatumPropertyType) object);
        {
            GeodeticDatumType lhsGeodeticDatum;
            lhsGeodeticDatum = this.getGeodeticDatum();
            GeodeticDatumType rhsGeodeticDatum;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeodeticDatumPropertyType) {
            final GeodeticDatumPropertyType copy = ((GeodeticDatumPropertyType) draftCopy);
            if (this.isSetGeodeticDatum()) {
                GeodeticDatumType sourceGeodeticDatum;
                sourceGeodeticDatum = this.getGeodeticDatum();
                GeodeticDatumType copyGeodeticDatum = ((GeodeticDatumType) strategy.copy(LocatorUtils.property(locator, "geodeticDatum", sourceGeodeticDatum), sourceGeodeticDatum));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeodeticDatumPropertyType) {
            final GeodeticDatumPropertyType target = this;
            final GeodeticDatumPropertyType leftObject = ((GeodeticDatumPropertyType) left);
            final GeodeticDatumPropertyType rightObject = ((GeodeticDatumPropertyType) right);
            {
                GeodeticDatumType lhsGeodeticDatum;
                lhsGeodeticDatum = leftObject.getGeodeticDatum();
                GeodeticDatumType rhsGeodeticDatum;
                rhsGeodeticDatum = rightObject.getGeodeticDatum();
                target.setGeodeticDatum(((GeodeticDatumType) strategy.merge(LocatorUtils.property(leftLocator, "geodeticDatum", lhsGeodeticDatum), LocatorUtils.property(rightLocator, "geodeticDatum", rhsGeodeticDatum), lhsGeodeticDatum, rhsGeodeticDatum)));
            }
            {
                List<String> lhsNilReason;
