 ...
 * 
 * <p>Java-Klasse für ConversionPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = ConversionPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConversionPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ConversionPropertyType that = ((ConversionPropertyType) object);
        {
            ConversionType lhsConversion;
            lhsConversion = this.getConversion();
            ConversionType rhsConversion;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof ConversionPropertyType) {
            final ConversionPropertyType copy = ((ConversionPropertyType) draftCopy);
            if (this.isSetConversion()) {
                ConversionType sourceConversion;
                sourceConversion = this.getConversion();
                ConversionType copyConversion = ((ConversionType) strategy.copy(LocatorUtils.property(locator, "conversion", sourceConversion), sourceConversion));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof ConversionPropertyType) {
            final ConversionPropertyType target = this;
            final ConversionPropertyType leftObject = ((ConversionPropertyType) left);
            final ConversionPropertyType rightObject = ((ConversionPropertyType) right);
            {
                ConversionType lhsConversion;
                lhsConversion = leftObject.getConversion();
                ConversionType rhsConversion;
                rhsConversion = rightObject.getConversion();
                target.setConversion(((ConversionType) strategy.merge(LocatorUtils.property(leftLocator, "conversion", lhsConversion), LocatorUtils.property(rightLocator, "conversion", rhsConversion), lhsConversion, rhsConversion)));
            }
            {
                List<String> lhsNilReason;
