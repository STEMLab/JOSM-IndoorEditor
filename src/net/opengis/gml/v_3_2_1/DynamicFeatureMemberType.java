...
/**
 * <p>Java-Klasse für DynamicFeatureMemberType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DynamicFeatureMemberType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DynamicFeatureMemberType that = ((DynamicFeatureMemberType) object);
        {
            ...
            lhsDynamicFeature = this.getDynamicFeature();
            List<JAXBElement<? extends DynamicFeatureType>> rhsDynamicFeature;
            rhsDynamicFeature = that.getDynamicFeature();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dynamicFeature", lhsDynamicFeature), LocatorUtils.property(thatLocator, "dynamicFeature", rhsDynamicFeature), lhsDynamicFeature, rhsDynamicFeature)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            List<JAXBElement<? extends DynamicFeatureType>> theDynamicFeature;
            theDynamicFeature = this.getDynamicFeature();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dynamicFeature", theDynamicFeature), currentHashCode, theDynamicFeature);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DynamicFeatureMemberType) {
            ...
            if (this.isSetDynamicFeature()) {
                ...
                List<JAXBElement<? extends DynamicFeatureType>> copyDynamicFeature = ((List<JAXBElement<? extends DynamicFeatureType>> ) strategy.copy(LocatorUtils.property(locator, "dynamicFeature", sourceDynamicFeature), sourceDynamicFeature));
                copy.unsetDynamicFeature();
                List<JAXBElement<? extends DynamicFeatureType>> uniqueDynamicFeaturel = copy.getDynamicFeature();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        ...
        if (right instanceof DynamicFeatureMemberType) {
            ...
            final DynamicFeatureMemberType rightObject = ((DynamicFeatureMemberType) right);
            {
                ...
                List<JAXBElement<? extends DynamicFeatureType>> uniqueDynamicFeaturel = target.getDynamicFeature();
                uniqueDynamicFeaturel.addAll(((List<JAXBElement<? extends DynamicFeatureType>> ) strategy.merge(LocatorUtils.property(leftLocator, "dynamicFeature", lhsDynamicFeature), LocatorUtils.property(rightLocator, "dynamicFeature", rhsDynamicFeature), lhsDynamicFeature, rhsDynamicFeature)));
            }
            {
                List<String> lhsNilReason;
    ...
    public void setDynamicFeature(List<JAXBElement<? extends DynamicFeatureType>> value) {
        List<JAXBElement<? extends DynamicFeatureType>> draftl = this.getDynamicFeature();
        draftl.addAll(value);
    }
