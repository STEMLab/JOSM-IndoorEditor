 ...
 * 
 * <p>Java-Klasse für DerivedCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            DerivedCRSType theDerivedCRS;
            theDerivedCRS = this.getDerivedCRS();
            strategy.appendField(locator, this, "derivedCRS", buffer, theDerivedCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = DerivedCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DerivedCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DerivedCRSPropertyType that = ((DerivedCRSPropertyType) object);
        {
            DerivedCRSType lhsDerivedCRS;
            lhsDerivedCRS = this.getDerivedCRS();
            DerivedCRSType rhsDerivedCRS;
            rhsDerivedCRS = that.getDerivedCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "derivedCRS", lhsDerivedCRS), LocatorUtils.property(thatLocator, "derivedCRS", rhsDerivedCRS), lhsDerivedCRS, rhsDerivedCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            DerivedCRSType theDerivedCRS;
            theDerivedCRS = this.getDerivedCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "derivedCRS", theDerivedCRS), currentHashCode, theDerivedCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof DerivedCRSPropertyType) {
            final DerivedCRSPropertyType copy = ((DerivedCRSPropertyType) draftCopy);
            if (this.isSetDerivedCRS()) {
                DerivedCRSType sourceDerivedCRS;
                sourceDerivedCRS = this.getDerivedCRS();
                DerivedCRSType copyDerivedCRS = ((DerivedCRSType) strategy.copy(LocatorUtils.property(locator, "derivedCRS", sourceDerivedCRS), sourceDerivedCRS));
                copy.setDerivedCRS(copyDerivedCRS);
            } else {
                copy.derivedCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof DerivedCRSPropertyType) {
            final DerivedCRSPropertyType target = this;
            final DerivedCRSPropertyType leftObject = ((DerivedCRSPropertyType) left);
            final DerivedCRSPropertyType rightObject = ((DerivedCRSPropertyType) right);
            {
                DerivedCRSType lhsDerivedCRS;
                lhsDerivedCRS = leftObject.getDerivedCRS();
                DerivedCRSType rhsDerivedCRS;
                rhsDerivedCRS = rightObject.getDerivedCRS();
                target.setDerivedCRS(((DerivedCRSType) strategy.merge(LocatorUtils.property(leftLocator, "derivedCRS", lhsDerivedCRS), LocatorUtils.property(rightLocator, "derivedCRS", rhsDerivedCRS), lhsDerivedCRS, rhsDerivedCRS)));
            }
            {
                List<String> lhsNilReason;
