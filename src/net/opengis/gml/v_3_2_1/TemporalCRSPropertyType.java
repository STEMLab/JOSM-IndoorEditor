 ...
 * 
 * <p>Java-Klasse für TemporalCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der temporalCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der temporalCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TemporalCRSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TemporalCRSType theTemporalCRS;
            theTemporalCRS = this.getTemporalCRS();
            strategy.appendField(locator, this, "temporalCRS", buffer, theTemporalCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TemporalCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TemporalCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TemporalCRSPropertyType that = ((TemporalCRSPropertyType) object);
        {
            TemporalCRSType lhsTemporalCRS;
            lhsTemporalCRS = this.getTemporalCRS();
            TemporalCRSType rhsTemporalCRS;
            rhsTemporalCRS = that.getTemporalCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "temporalCRS", lhsTemporalCRS), LocatorUtils.property(thatLocator, "temporalCRS", rhsTemporalCRS), lhsTemporalCRS, rhsTemporalCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TemporalCRSType theTemporalCRS;
            theTemporalCRS = this.getTemporalCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "temporalCRS", theTemporalCRS), currentHashCode, theTemporalCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TemporalCRSPropertyType) {
            final TemporalCRSPropertyType copy = ((TemporalCRSPropertyType) draftCopy);
            if (this.isSetTemporalCRS()) {
                TemporalCRSType sourceTemporalCRS;
                sourceTemporalCRS = this.getTemporalCRS();
                TemporalCRSType copyTemporalCRS = ((TemporalCRSType) strategy.copy(LocatorUtils.property(locator, "temporalCRS", sourceTemporalCRS), sourceTemporalCRS));
                copy.setTemporalCRS(copyTemporalCRS);
            } else {
                copy.temporalCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TemporalCRSPropertyType) {
            final TemporalCRSPropertyType target = this;
            final TemporalCRSPropertyType leftObject = ((TemporalCRSPropertyType) left);
            final TemporalCRSPropertyType rightObject = ((TemporalCRSPropertyType) right);
            {
                TemporalCRSType lhsTemporalCRS;
                lhsTemporalCRS = leftObject.getTemporalCRS();
                TemporalCRSType rhsTemporalCRS;
                rhsTemporalCRS = rightObject.getTemporalCRS();
                target.setTemporalCRS(((TemporalCRSType) strategy.merge(LocatorUtils.property(leftLocator, "temporalCRS", lhsTemporalCRS), LocatorUtils.property(rightLocator, "temporalCRS", rhsTemporalCRS), lhsTemporalCRS, rhsTemporalCRS)));
            }
            {
                List<String> lhsNilReason;
