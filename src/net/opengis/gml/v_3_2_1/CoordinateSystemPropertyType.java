 ...
 * 
 * <p>Java-Klasse für CoordinateSystemPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractCoordinateSystem", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractCoordinateSystem-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractCoordinateSystem-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TemporalCSType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCoordinateSystemType> theAbstractCoordinateSystem;
            theAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
            strategy.appendField(locator, this, "abstractCoordinateSystem", buffer, theAbstractCoordinateSystem);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CoordinateSystemPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CoordinateSystemPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            JAXBElement<? extends AbstractCoordinateSystemType> lhsAbstractCoordinateSystem;
            lhsAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
            JAXBElement<? extends AbstractCoordinateSystemType> rhsAbstractCoordinateSystem;
            rhsAbstractCoordinateSystem = that.getAbstractCoordinateSystem();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractCoordinateSystem", lhsAbstractCoordinateSystem), LocatorUtils.property(thatLocator, "abstractCoordinateSystem", rhsAbstractCoordinateSystem), lhsAbstractCoordinateSystem, rhsAbstractCoordinateSystem)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCoordinateSystemType> theAbstractCoordinateSystem;
            theAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractCoordinateSystem", theAbstractCoordinateSystem), currentHashCode, theAbstractCoordinateSystem);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CoordinateSystemPropertyType) {
            final CoordinateSystemPropertyType copy = ((CoordinateSystemPropertyType) draftCopy);
            if (this.isSetAbstractCoordinateSystem()) {
                JAXBElement<? extends AbstractCoordinateSystemType> sourceAbstractCoordinateSystem;
                sourceAbstractCoordinateSystem = this.getAbstractCoordinateSystem();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCoordinateSystemType> copyAbstractCoordinateSystem = ((JAXBElement<? extends AbstractCoordinateSystemType> ) strategy.copy(LocatorUtils.property(locator, "abstractCoordinateSystem", sourceAbstractCoordinateSystem), sourceAbstractCoordinateSystem));
                copy.setAbstractCoordinateSystem(copyAbstractCoordinateSystem);
            } else {
                copy.abstractCoordinateSystem = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateSystemPropertyType) {
            final CoordinateSystemPropertyType target = this;
            final CoordinateSystemPropertyType leftObject = ((CoordinateSystemPropertyType) left);
            final CoordinateSystemPropertyType rightObject = ((CoordinateSystemPropertyType) right);
            {
                JAXBElement<? extends AbstractCoordinateSystemType> lhsAbstractCoordinateSystem;
                lhsAbstractCoordinateSystem = leftObject.getAbstractCoordinateSystem();
                JAXBElement<? extends AbstractCoordinateSystemType> rhsAbstractCoordinateSystem;
                rhsAbstractCoordinateSystem = rightObject.getAbstractCoordinateSystem();
                target.setAbstractCoordinateSystem(((JAXBElement<? extends AbstractCoordinateSystemType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCoordinateSystem", lhsAbstractCoordinateSystem), LocatorUtils.property(rightLocator, "abstractCoordinateSystem", rhsAbstractCoordinateSystem), lhsAbstractCoordinateSystem, rhsAbstractCoordinateSystem)));
            }
            {
                List<String> lhsNilReason;
