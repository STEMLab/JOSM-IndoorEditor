...
/**
 * <p>Java-Klasse für OperationPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractOperation", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractOperation-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractOperation-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AbstractGeneralConversionType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theAbstractOperation;
            theAbstractOperation = this.getAbstractOperation();
            strategy.appendField(locator, this, "abstractOperation", buffer, theAbstractOperation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = OperationPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OperationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OperationPropertyType that = ((OperationPropertyType) object);
        {
            JAXBElement<? extends AbstractCoordinateOperationType> lhsAbstractOperation;
            lhsAbstractOperation = this.getAbstractOperation();
            JAXBElement<? extends AbstractCoordinateOperationType> rhsAbstractOperation;
            rhsAbstractOperation = that.getAbstractOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractOperation", lhsAbstractOperation), LocatorUtils.property(thatLocator, "abstractOperation", rhsAbstractOperation), lhsAbstractOperation, rhsAbstractOperation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractCoordinateOperationType> theAbstractOperation;
            theAbstractOperation = this.getAbstractOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractOperation", theAbstractOperation), currentHashCode, theAbstractOperation);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OperationPropertyType) {
            final OperationPropertyType copy = ((OperationPropertyType) draftCopy);
            if (this.isSetAbstractOperation()) {
                JAXBElement<? extends AbstractCoordinateOperationType> sourceAbstractOperation;
                sourceAbstractOperation = this.getAbstractOperation();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractCoordinateOperationType> copyAbstractOperation = ((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.copy(LocatorUtils.property(locator, "abstractOperation", sourceAbstractOperation), sourceAbstractOperation));
                copy.setAbstractOperation(copyAbstractOperation);
            } else {
                copy.abstractOperation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof OperationPropertyType) {
            final OperationPropertyType target = this;
            final OperationPropertyType leftObject = ((OperationPropertyType) left);
            final OperationPropertyType rightObject = ((OperationPropertyType) right);
            {
                JAXBElement<? extends AbstractCoordinateOperationType> lhsAbstractOperation;
                lhsAbstractOperation = leftObject.getAbstractOperation();
                JAXBElement<? extends AbstractCoordinateOperationType> rhsAbstractOperation;
                rhsAbstractOperation = rightObject.getAbstractOperation();
                target.setAbstractOperation(((JAXBElement<? extends AbstractCoordinateOperationType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractOperation", lhsAbstractOperation), LocatorUtils.property(rightLocator, "abstractOperation", rhsAbstractOperation), lhsAbstractOperation, rhsAbstractOperation)));
            }
            {
                List<String> lhsNilReason;
