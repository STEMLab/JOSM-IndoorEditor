...
/**
 * <p>Java-Klasse für FaceOrTopoSolidPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = FaceOrTopoSolidPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FaceOrTopoSolidPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FaceOrTopoSolidPropertyType that = ((FaceOrTopoSolidPropertyType) object);
        {
            FaceType lhsFace;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof FaceOrTopoSolidPropertyType) {
            final FaceOrTopoSolidPropertyType copy = ((FaceOrTopoSolidPropertyType) draftCopy);
            if (this.isSetFace()) {
                FaceType sourceFace;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof FaceOrTopoSolidPropertyType) {
            final FaceOrTopoSolidPropertyType target = this;
            final FaceOrTopoSolidPropertyType leftObject = ((FaceOrTopoSolidPropertyType) left);
            final FaceOrTopoSolidPropertyType rightObject = ((FaceOrTopoSolidPropertyType) right);
            {
                FaceType lhsFace;
