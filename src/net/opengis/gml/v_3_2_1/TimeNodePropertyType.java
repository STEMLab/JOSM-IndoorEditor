 ...
 * 
 * <p>Java-Klasse für TimeNodePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der timeNode-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link TimeNodeType }
    ...
    /**
     * Legt den Wert der timeNode-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeNodeType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TimeNodeType theTimeNode;
            theTimeNode = this.getTimeNode();
            strategy.appendField(locator, this, "timeNode", buffer, theTimeNode);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
        ...
        {
            String theTYPE;
            theTYPE = TimeNodePropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TimeNodePropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TimeNodePropertyType that = ((TimeNodePropertyType) object);
        {
            TimeNodeType lhsTimeNode;
            lhsTimeNode = this.getTimeNode();
            TimeNodeType rhsTimeNode;
            rhsTimeNode = that.getTimeNode();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "timeNode", lhsTimeNode), LocatorUtils.property(thatLocator, "timeNode", rhsTimeNode), lhsTimeNode, rhsTimeNode)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TimeNodeType theTimeNode;
            theTimeNode = this.getTimeNode();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "timeNode", theTimeNode), currentHashCode, theTimeNode);
        }
        {
            boolean theOwns;
            theOwns = this.isOwns();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TimeNodePropertyType) {
            final TimeNodePropertyType copy = ((TimeNodePropertyType) draftCopy);
            if (this.isSetTimeNode()) {
                TimeNodeType sourceTimeNode;
                sourceTimeNode = this.getTimeNode();
                TimeNodeType copyTimeNode = ((TimeNodeType) strategy.copy(LocatorUtils.property(locator, "timeNode", sourceTimeNode), sourceTimeNode));
                copy.setTimeNode(copyTimeNode);
            } else {
                copy.timeNode = null;
            }
            if (this.isSetOwns()) {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TimeNodePropertyType) {
            final TimeNodePropertyType target = this;
            final TimeNodePropertyType leftObject = ((TimeNodePropertyType) left);
            final TimeNodePropertyType rightObject = ((TimeNodePropertyType) right);
            {
                TimeNodeType lhsTimeNode;
                lhsTimeNode = leftObject.getTimeNode();
                TimeNodeType rhsTimeNode;
                rhsTimeNode = rightObject.getTimeNode();
                target.setTimeNode(((TimeNodeType) strategy.merge(LocatorUtils.property(leftLocator, "timeNode", lhsTimeNode), LocatorUtils.property(rightLocator, "timeNode", rhsTimeNode), lhsTimeNode, rhsTimeNode)));
            }
            {
                boolean lhsOwns;
