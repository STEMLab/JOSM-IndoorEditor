...
/**
 * <p>Java-Klasse für TopoSolidPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = TopoSolidPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TopoSolidPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TopoSolidPropertyType that = ((TopoSolidPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TopoSolidPropertyType) {
            final TopoSolidPropertyType copy = ((TopoSolidPropertyType) draftCopy);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TopoSolidPropertyType) {
            final TopoSolidPropertyType target = this;
            final TopoSolidPropertyType leftObject = ((TopoSolidPropertyType) left);
            final TopoSolidPropertyType rightObject = ((TopoSolidPropertyType) right);
            {
                TopoSolidType lhsTopoSolid;
