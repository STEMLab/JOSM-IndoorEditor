 ...
 * 
 * <p>Java-Klasse für GeodeticCRSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der geodeticCRS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der geodeticCRS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link GeodeticCRSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            GeodeticCRSType theGeodeticCRS;
            theGeodeticCRS = this.getGeodeticCRS();
            strategy.appendField(locator, this, "geodeticCRS", buffer, theGeodeticCRS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = GeodeticCRSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeodeticCRSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeodeticCRSPropertyType that = ((GeodeticCRSPropertyType) object);
        {
            GeodeticCRSType lhsGeodeticCRS;
            lhsGeodeticCRS = this.getGeodeticCRS();
            GeodeticCRSType rhsGeodeticCRS;
            rhsGeodeticCRS = that.getGeodeticCRS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geodeticCRS", lhsGeodeticCRS), LocatorUtils.property(thatLocator, "geodeticCRS", rhsGeodeticCRS), lhsGeodeticCRS, rhsGeodeticCRS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            GeodeticCRSType theGeodeticCRS;
            theGeodeticCRS = this.getGeodeticCRS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geodeticCRS", theGeodeticCRS), currentHashCode, theGeodeticCRS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof GeodeticCRSPropertyType) {
            final GeodeticCRSPropertyType copy = ((GeodeticCRSPropertyType) draftCopy);
            if (this.isSetGeodeticCRS()) {
                GeodeticCRSType sourceGeodeticCRS;
                sourceGeodeticCRS = this.getGeodeticCRS();
                GeodeticCRSType copyGeodeticCRS = ((GeodeticCRSType) strategy.copy(LocatorUtils.property(locator, "geodeticCRS", sourceGeodeticCRS), sourceGeodeticCRS));
                copy.setGeodeticCRS(copyGeodeticCRS);
            } else {
                copy.geodeticCRS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof GeodeticCRSPropertyType) {
            final GeodeticCRSPropertyType target = this;
            final GeodeticCRSPropertyType leftObject = ((GeodeticCRSPropertyType) left);
            final GeodeticCRSPropertyType rightObject = ((GeodeticCRSPropertyType) right);
            {
                GeodeticCRSType lhsGeodeticCRS;
                lhsGeodeticCRS = leftObject.getGeodeticCRS();
                GeodeticCRSType rhsGeodeticCRS;
                rhsGeodeticCRS = rightObject.getGeodeticCRS();
                target.setGeodeticCRS(((GeodeticCRSType) strategy.merge(LocatorUtils.property(leftLocator, "geodeticCRS", lhsGeodeticCRS), LocatorUtils.property(rightLocator, "geodeticCRS", rhsGeodeticCRS), lhsGeodeticCRS, rhsGeodeticCRS)));
            }
            {
                List<String> lhsNilReason;
