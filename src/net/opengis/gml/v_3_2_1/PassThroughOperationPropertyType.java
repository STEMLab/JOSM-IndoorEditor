 ...
 * 
 * <p>Java-Klasse für PassThroughOperationPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            PassThroughOperationType thePassThroughOperation;
            thePassThroughOperation = this.getPassThroughOperation();
            strategy.appendField(locator, this, "passThroughOperation", buffer, thePassThroughOperation);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = PassThroughOperationPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PassThroughOperationPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PassThroughOperationPropertyType that = ((PassThroughOperationPropertyType) object);
        {
            PassThroughOperationType lhsPassThroughOperation;
            lhsPassThroughOperation = this.getPassThroughOperation();
            PassThroughOperationType rhsPassThroughOperation;
            rhsPassThroughOperation = that.getPassThroughOperation();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "passThroughOperation", lhsPassThroughOperation), LocatorUtils.property(thatLocator, "passThroughOperation", rhsPassThroughOperation), lhsPassThroughOperation, rhsPassThroughOperation)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            PassThroughOperationType thePassThroughOperation;
            thePassThroughOperation = this.getPassThroughOperation();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "passThroughOperation", thePassThroughOperation), currentHashCode, thePassThroughOperation);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PassThroughOperationPropertyType) {
            final PassThroughOperationPropertyType copy = ((PassThroughOperationPropertyType) draftCopy);
            if (this.isSetPassThroughOperation()) {
                PassThroughOperationType sourcePassThroughOperation;
                sourcePassThroughOperation = this.getPassThroughOperation();
                PassThroughOperationType copyPassThroughOperation = ((PassThroughOperationType) strategy.copy(LocatorUtils.property(locator, "passThroughOperation", sourcePassThroughOperation), sourcePassThroughOperation));
                copy.setPassThroughOperation(copyPassThroughOperation);
            } else {
                copy.passThroughOperation = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PassThroughOperationPropertyType) {
            final PassThroughOperationPropertyType target = this;
            final PassThroughOperationPropertyType leftObject = ((PassThroughOperationPropertyType) left);
            final PassThroughOperationPropertyType rightObject = ((PassThroughOperationPropertyType) right);
            {
                PassThroughOperationType lhsPassThroughOperation;
                lhsPassThroughOperation = leftObject.getPassThroughOperation();
                PassThroughOperationType rhsPassThroughOperation;
                rhsPassThroughOperation = rightObject.getPassThroughOperation();
                target.setPassThroughOperation(((PassThroughOperationType) strategy.merge(LocatorUtils.property(leftLocator, "passThroughOperation", lhsPassThroughOperation), LocatorUtils.property(rightLocator, "passThroughOperation", rhsPassThroughOperation), lhsPassThroughOperation, rhsPassThroughOperation)));
            }
            {
                List<String> lhsNilReason;
