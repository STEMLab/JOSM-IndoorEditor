 ...
 * 
 * <p>Java-Klasse für PrimeMeridianPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = PrimeMeridianPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PrimeMeridianPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PrimeMeridianPropertyType that = ((PrimeMeridianPropertyType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PrimeMeridianPropertyType) {
            final PrimeMeridianPropertyType copy = ((PrimeMeridianPropertyType) draftCopy);
            if (this.isSetPrimeMeridian()) {
                PrimeMeridianType sourcePrimeMeridian;
                sourcePrimeMeridian = this.getPrimeMeridian();
                PrimeMeridianType copyPrimeMeridian = ((PrimeMeridianType) strategy.copy(LocatorUtils.property(locator, "primeMeridian", sourcePrimeMeridian), sourcePrimeMeridian));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof PrimeMeridianPropertyType) {
            final PrimeMeridianPropertyType target = this;
            final PrimeMeridianPropertyType leftObject = ((PrimeMeridianPropertyType) left);
            final PrimeMeridianPropertyType rightObject = ((PrimeMeridianPropertyType) right);
            {
                PrimeMeridianType lhsPrimeMeridian;
                lhsPrimeMeridian = leftObject.getPrimeMeridian();
                PrimeMeridianType rhsPrimeMeridian;
                rhsPrimeMeridian = rightObject.getPrimeMeridian();
                target.setPrimeMeridian(((PrimeMeridianType) strategy.merge(LocatorUtils.property(leftLocator, "primeMeridian", lhsPrimeMeridian), LocatorUtils.property(rightLocator, "primeMeridian", rhsPrimeMeridian), lhsPrimeMeridian, rhsPrimeMeridian)));
            }
            {
                List<String> lhsNilReason;
