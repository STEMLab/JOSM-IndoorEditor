    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der abstractDQPositionalAccuracy-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Element }
    ...
    /**
     * Legt den Wert der abstractDQPositionalAccuracy-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Element }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            Element theAbstractDQPositionalAccuracy;
            theAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            strategy.appendField(locator, this, "abstractDQPositionalAccuracy", buffer, theAbstractDQPositionalAccuracy);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = CoordinateOperationAccuracyElement.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CoordinateOperationAccuracyElement)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CoordinateOperationAccuracyElement that = ((CoordinateOperationAccuracyElement) object);
        {
            Element lhsAbstractDQPositionalAccuracy;
            lhsAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            Element rhsAbstractDQPositionalAccuracy;
            rhsAbstractDQPositionalAccuracy = that.getAbstractDQPositionalAccuracy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractDQPositionalAccuracy", lhsAbstractDQPositionalAccuracy), LocatorUtils.property(thatLocator, "abstractDQPositionalAccuracy", rhsAbstractDQPositionalAccuracy), lhsAbstractDQPositionalAccuracy, rhsAbstractDQPositionalAccuracy)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            Element theAbstractDQPositionalAccuracy;
            theAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractDQPositionalAccuracy", theAbstractDQPositionalAccuracy), currentHashCode, theAbstractDQPositionalAccuracy);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof CoordinateOperationAccuracyElement) {
            final CoordinateOperationAccuracyElement copy = ((CoordinateOperationAccuracyElement) draftCopy);
            if (this.isSetAbstractDQPositionalAccuracy()) {
                Element sourceAbstractDQPositionalAccuracy;
                sourceAbstractDQPositionalAccuracy = this.getAbstractDQPositionalAccuracy();
                Element copyAbstractDQPositionalAccuracy = ((Element) strategy.copy(LocatorUtils.property(locator, "abstractDQPositionalAccuracy", sourceAbstractDQPositionalAccuracy), sourceAbstractDQPositionalAccuracy));
                copy.setAbstractDQPositionalAccuracy(copyAbstractDQPositionalAccuracy);
            } else {
                copy.abstractDQPositionalAccuracy = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof CoordinateOperationAccuracyElement) {
            final CoordinateOperationAccuracyElement target = this;
            final CoordinateOperationAccuracyElement leftObject = ((CoordinateOperationAccuracyElement) left);
            final CoordinateOperationAccuracyElement rightObject = ((CoordinateOperationAccuracyElement) right);
            {
                Element lhsAbstractDQPositionalAccuracy;
                lhsAbstractDQPositionalAccuracy = leftObject.getAbstractDQPositionalAccuracy();
                Element rhsAbstractDQPositionalAccuracy;
                rhsAbstractDQPositionalAccuracy = rightObject.getAbstractDQPositionalAccuracy();
                target.setAbstractDQPositionalAccuracy(((Element) strategy.merge(LocatorUtils.property(leftLocator, "abstractDQPositionalAccuracy", lhsAbstractDQPositionalAccuracy), LocatorUtils.property(rightLocator, "abstractDQPositionalAccuracy", rhsAbstractDQPositionalAccuracy), lhsAbstractDQPositionalAccuracy, rhsAbstractDQPositionalAccuracy)));
            }
            {
                List<String> lhsNilReason;
