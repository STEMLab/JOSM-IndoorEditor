 ...
 * 
 * <p>Java-Klasse für MultiCurvePropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theTYPE;
            theTYPE = MultiCurvePropertyType.TYPE;
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof MultiCurvePropertyType) {
            final MultiCurvePropertyType target = this;
            final MultiCurvePropertyType leftObject = ((MultiCurvePropertyType) left);
            final MultiCurvePropertyType rightObject = ((MultiCurvePropertyType) right);
            {
                MultiCurveType lhsMultiCurve;
                lhsMultiCurve = leftObject.getMultiCurve();
                MultiCurveType rhsMultiCurve;
                rhsMultiCurve = rightObject.getMultiCurve();
                target.setMultiCurve(((MultiCurveType) strategy.merge(LocatorUtils.property(leftLocator, "multiCurve", lhsMultiCurve), LocatorUtils.property(rightLocator, "multiCurve", rhsMultiCurve), lhsMultiCurve, rhsMultiCurve)));
            }
            {
                List<String> lhsNilReason;
