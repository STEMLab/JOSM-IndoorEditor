...
/**
 * <p>Java-Klasse für TemporalCSPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    /**
     * Ruft den Wert der temporalCS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link TemporalCSType }
    ...
    /**
     * Legt den Wert der temporalCS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link TemporalCSType }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            TemporalCSType theTemporalCS;
            theTemporalCS = this.getTemporalCS();
            strategy.appendField(locator, this, "temporalCS", buffer, theTemporalCS);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = TemporalCSPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TemporalCSPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TemporalCSPropertyType that = ((TemporalCSPropertyType) object);
        {
            TemporalCSType lhsTemporalCS;
            lhsTemporalCS = this.getTemporalCS();
            TemporalCSType rhsTemporalCS;
            rhsTemporalCS = that.getTemporalCS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "temporalCS", lhsTemporalCS), LocatorUtils.property(thatLocator, "temporalCS", rhsTemporalCS), lhsTemporalCS, rhsTemporalCS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            TemporalCSType theTemporalCS;
            theTemporalCS = this.getTemporalCS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "temporalCS", theTemporalCS), currentHashCode, theTemporalCS);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TemporalCSPropertyType) {
            final TemporalCSPropertyType copy = ((TemporalCSPropertyType) draftCopy);
            if (this.isSetTemporalCS()) {
                TemporalCSType sourceTemporalCS;
                sourceTemporalCS = this.getTemporalCS();
                TemporalCSType copyTemporalCS = ((TemporalCSType) strategy.copy(LocatorUtils.property(locator, "temporalCS", sourceTemporalCS), sourceTemporalCS));
                copy.setTemporalCS(copyTemporalCS);
            } else {
                copy.temporalCS = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof TemporalCSPropertyType) {
            final TemporalCSPropertyType target = this;
            final TemporalCSPropertyType leftObject = ((TemporalCSPropertyType) left);
            final TemporalCSPropertyType rightObject = ((TemporalCSPropertyType) right);
            {
                TemporalCSType lhsTemporalCS;
                lhsTemporalCS = leftObject.getTemporalCS();
                TemporalCSType rhsTemporalCS;
                rhsTemporalCS = rightObject.getTemporalCS();
                target.setTemporalCS(((TemporalCSType) strategy.merge(LocatorUtils.property(leftLocator, "temporalCS", lhsTemporalCS), LocatorUtils.property(rightLocator, "temporalCS", rhsTemporalCS), lhsTemporalCS, rhsTemporalCS)));
            }
            {
                List<String> lhsNilReason;
