 ...
 * 
 * <p>Java-Klasse für AbstractGeneralOperationParameterPropertyType complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, HashCode, MergeFrom, ToString
{
    ...
    @XmlElementRef(name = "AbstractGeneralOperationParameter", namespace = "http://www.opengis.net/gml/3.2", type = JAXBElement.class)
    ...
    /**
     * Ruft den Wert der abstractGeneralOperationParameter-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der abstractGeneralOperationParameter-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link OperationParameterType }{@code >}
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            JAXBElement<? extends AbstractGeneralOperationParameterType> theAbstractGeneralOperationParameter;
            theAbstractGeneralOperationParameter = this.getAbstractGeneralOperationParameter();
            strategy.appendField(locator, this, "abstractGeneralOperationParameter", buffer, theAbstractGeneralOperationParameter);
        }
        {
        ...
        {
            String theTYPE;
            theTYPE = AbstractGeneralOperationParameterPropertyType.TYPE;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AbstractGeneralOperationParameterPropertyType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AbstractGeneralOperationParameterPropertyType that = ((AbstractGeneralOperationParameterPropertyType) object);
        {
            JAXBElement<? extends AbstractGeneralOperationParameterType> lhsAbstractGeneralOperationParameter;
            lhsAbstractGeneralOperationParameter = this.getAbstractGeneralOperationParameter();
            JAXBElement<? extends AbstractGeneralOperationParameterType> rhsAbstractGeneralOperationParameter;
            rhsAbstractGeneralOperationParameter = that.getAbstractGeneralOperationParameter();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "abstractGeneralOperationParameter", lhsAbstractGeneralOperationParameter), LocatorUtils.property(thatLocator, "abstractGeneralOperationParameter", rhsAbstractGeneralOperationParameter), lhsAbstractGeneralOperationParameter, rhsAbstractGeneralOperationParameter)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            JAXBElement<? extends AbstractGeneralOperationParameterType> theAbstractGeneralOperationParameter;
            theAbstractGeneralOperationParameter = this.getAbstractGeneralOperationParameter();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "abstractGeneralOperationParameter", theAbstractGeneralOperationParameter), currentHashCode, theAbstractGeneralOperationParameter);
        }
        {
            List<String> theNilReason;
            theNilReason = this.getNilReason();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof AbstractGeneralOperationParameterPropertyType) {
            final AbstractGeneralOperationParameterPropertyType copy = ((AbstractGeneralOperationParameterPropertyType) draftCopy);
            if (this.isSetAbstractGeneralOperationParameter()) {
                JAXBElement<? extends AbstractGeneralOperationParameterType> sourceAbstractGeneralOperationParameter;
                sourceAbstractGeneralOperationParameter = this.getAbstractGeneralOperationParameter();
                @SuppressWarnings("unchecked")
                JAXBElement<? extends AbstractGeneralOperationParameterType> copyAbstractGeneralOperationParameter = ((JAXBElement<? extends AbstractGeneralOperationParameterType> ) strategy.copy(LocatorUtils.property(locator, "abstractGeneralOperationParameter", sourceAbstractGeneralOperationParameter), sourceAbstractGeneralOperationParameter));
                copy.setAbstractGeneralOperationParameter(copyAbstractGeneralOperationParameter);
            } else {
                copy.abstractGeneralOperationParameter = null;
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy strategy) {
        if (right instanceof AbstractGeneralOperationParameterPropertyType) {
            final AbstractGeneralOperationParameterPropertyType target = this;
            final AbstractGeneralOperationParameterPropertyType leftObject = ((AbstractGeneralOperationParameterPropertyType) left);
            final AbstractGeneralOperationParameterPropertyType rightObject = ((AbstractGeneralOperationParameterPropertyType) right);
            {
                JAXBElement<? extends AbstractGeneralOperationParameterType> lhsAbstractGeneralOperationParameter;
                lhsAbstractGeneralOperationParameter = leftObject.getAbstractGeneralOperationParameter();
                JAXBElement<? extends AbstractGeneralOperationParameterType> rhsAbstractGeneralOperationParameter;
                rhsAbstractGeneralOperationParameter = rightObject.getAbstractGeneralOperationParameter();
                target.setAbstractGeneralOperationParameter(((JAXBElement<? extends AbstractGeneralOperationParameterType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractGeneralOperationParameter", lhsAbstractGeneralOperationParameter), LocatorUtils.property(rightLocator, "abstractGeneralOperationParameter", rhsAbstractGeneralOperationParameter), lhsAbstractGeneralOperationParameter, rhsAbstractGeneralOperationParameter)));
            }
            {
                List<String> lhsNilReason;
