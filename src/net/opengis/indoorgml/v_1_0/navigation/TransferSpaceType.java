...
/**
 * <p>Java class for TransferSpaceType complex type.
 * 
...
@XmlType(name = "TransferSpaceType")
@XmlSeeAlso({
    AnchorSpaceType.class,
    TransitionSpaceType.class,
    ConnectionSpaceType.class
})
public class TransferSpaceType
